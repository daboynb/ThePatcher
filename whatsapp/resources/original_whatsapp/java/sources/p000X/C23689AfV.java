...
public class C23689AfV extends ReplacementSpan {
    public int A00;
    public int A01;
    public Rect A02;
    ...
    public static void A00(Paint.FontMetricsInt fontMetricsInt, int i, int i2) {
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (this instanceof BBE) {
            BBE bbe = (BBE) this;
            A01 = bbe.A01 == 1 ? bbe.A01(i6, i7) : bbe.A01(i3 - i4, i5 - i4);
        } else {
            A01 = A01(i6, i7);
        }
        float f2 = f + this.A05.left;
        canvas.translate(f2, i4 + A01);
        this.A06.draw(canvas);
        canvas.translate(-f2, -r12);
    }

    public C23689AfV(Rect rect, Drawable drawable, int i) {
        this.A06 = drawable;
        this.A03 = i;
        this.A05 = rect;
        A02();
    ...
    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (fontMetricsInt != null) {
            if (this instanceof BBE) {
                ...
                int A01 = bbe.A01(i3, i4);
                int i6 = ((C23689AfV) bbe).A00 + A01;
                int i7 = bbe.A00;
                Rect rect = bbe.A05;
                int i8 = A01 - rect.top;
                if (i7 == 2) {
