...
public final class C24564Axo extends COs implements DX5 {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C24564Axo(JSONObject jSONObject) {
        super(jSONObject);
    ...
    @Override // p000X.DX5
    public InterfaceC30142DWz AQd() {
        return (InterfaceC30142DWz) A06(C24563Axn.class, "bank_info");
    }
