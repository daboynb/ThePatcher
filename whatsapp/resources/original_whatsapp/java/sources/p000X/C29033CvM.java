...
public final class C29033CvM implements DVY {
    public static final Parcelable.Creator CREATOR = new C27554CSl();
    public C29035CvO A00;
    public final C29030CvJ A01;
    public final List A02;

    public C29033CvM(C29035CvO c29035CvO, C29030CvJ c29030CvJ, List list) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C29033CvM) {
                C29033CvM c29033CvM = (C29033CvM) obj;
                if (!C00C.areEqual(this.A01, c29033CvM.A01) || !C00C.areEqual(this.A00, c29033CvM.A00) || !C00C.areEqual(this.A02, c29033CvM.A02)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        A04.append("UpiMerchantVpa(internalMetadata=");
        A04.append(this.A01);
