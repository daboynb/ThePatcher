...
public final class FJM {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof FJM) {
                FJM fjm = (FJM) obj;
                if (!C00C.areEqual(this.A01, fjm.A01) || !C00C.areEqual(this.A00, fjm.A00)) {
                }
            }
            return false;
        }
    ...
    public FJM(JSONObject jSONObject) {
        ?? r4;
    ...
    public String toString() {
        ...
        A04.append("WamoRecentActivityResponse(promo=");
        A04.append(this.A01);
