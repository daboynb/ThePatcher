...
public abstract class IWn {
    ...
    public static int A00(Object obj, long j) {
        return C41477Ihn.A00.A00.getInt(obj, (-4) & j);
    }

    public byte A01(Object obj, long j) {
        int A08;
        boolean z = this instanceof C38317H9m;
        boolean z2 = C41477Ihn.A03;
        if (z) {
            if (z2) {
    ...
    public void A06(Object obj, long j, byte b) {
        boolean z = C41477Ihn.A03;
        long j2 = j & (-4);
        IWn iWn = C41477Ihn.A00;
        int A04 = iWn.A04(obj, j2);
        int i = (int) j;
        if (z) {
            iWn.A09(obj, j2, AbstractC37205Gi4.A0A(i ^ (-1), A04, b));
        } else {
            iWn.A09(obj, j2, AbstractC37205Gi4.A0A(i, A04, b));
        }
    }
