...
public final class ET4 extends FZm {
    public final String A00;
    public final String A01;
    public final EnumC147486g1 A02;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ET4(EnumC147486g1 enumC147486g1, String str) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof ET4) {
                ...
                if (!C00C.areEqual(this.A01, et4.A01) || this.A02 != et4.A02) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        FZm.A01(A04, "MusicConsumptionRequest(requestHost=");
