...
public class C43508Jir extends C0FC implements InterfaceC43910Jru {
    ...
    public boolean A0J(C0FC c0fc) {
        if (c0fc instanceof C43508Jir) {
            return Arrays.equals(this.A00, ((C43508Jir) c0fc).A00);
        }
        return false;
    }
    ...
    public C43508Jir(String str) {
        this.A00 = C0F1.A03(str);
    }

    public C43508Jir(byte[] bArr) {
        this.A00 = bArr;
    }
}
