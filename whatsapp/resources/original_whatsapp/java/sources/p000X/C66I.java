...
public final class C66I extends AbstractC265514n implements InterfaceC265314j {
    public static final C66I DEFAULT_INSTANCE;
    ...
    public C1386067l quotedMessage_;
    public String stanzaId_ = "";
    public String participant_ = "";

    static {
        C66I c66i = new C66I();
        DEFAULT_INSTANCE = c66i;
        AbstractC265514n.A0B(c66i, C66I.class);
    }

    public static C66I parseFrom(ByteBuffer byteBuffer) {
        return (C66I) AbstractC265514n.A04(DEFAULT_INSTANCE, byteBuffer);
    }
        ...
        switch (anonymousClass157) {
            ...
            case NEW_BUILDER:
                return new AnonymousClass159() { // from class: X.61L
                    {
                        C66I c66i = C66I.DEFAULT_INSTANCE;
                    }
                };
