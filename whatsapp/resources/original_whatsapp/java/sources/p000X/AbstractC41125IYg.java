...
public abstract class AbstractC41125IYg {
    ...
    public static int A00(int i) {
        ...
        int i4;
        int i5;
        if (!AbstractC34841ae.A1N(i & (-2097152), -2097152) || (i2 = (i >>> 19) & 3) == 1 || (i3 = (i >>> 17) & 3) == 0 || (i4 = (i >>> 12) & 15) == 0 || i4 == 15 || (i5 = (i >>> 10) & 3) == 3) {
            return -1;
        }
        int i6 = A05[i5];
        if (i2 == 2) {
    ...
    public static int A01(int i) {
        int i2;
        int i3;
        if (AbstractC34841ae.A1N(i & (-2097152), -2097152) && (i2 = (i >>> 19) & 3) != 1 && (i3 = (i >>> 17) & 3) != 0) {
            int i4 = (i >>> 12) & 15;
            int i5 = (i >>> 10) & 3;
            if (i4 != 0 && i4 != 15 && i5 != 3) {
                if (i3 == 1) {
