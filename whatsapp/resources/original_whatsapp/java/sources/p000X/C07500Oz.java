...
public final class C07500Oz<E> extends AbstractC07490Oy<E> {
    public static final Object[] A03 = new Object[0];
    public int A00;
    public Object[] A01;
    public int A02;

    public C07500Oz(Collection collection) {
    ...
    private final void A01(int i, int i2) {
        ...
        if (i < i2) {
            AnonymousClass025.A05(objArr, i, i2);
        } else {
            Arrays.fill(objArr, i, objArr.length, (Object) null);
            AnonymousClass025.A05(this.A01, 0, i2);
        }
    }
    ...
    public boolean removeAll(Collection collection) {
        ...
        if (!isEmpty() && this.A01.length != 0) {
            ...
            if (i >= size) {
                ...
                AnonymousClass025.A05(objArr, i2, size);
            }
            if (z) {
                ((AbstractList) this).modCount++;
                int i5 = i2 - this.A00;
    ...
    public Object[] toArray(Object[] objArr) {
        ...
        int i = this.A00;
        if (i < size) {
            AnonymousClass025.A06(objArr2, 0, objArr, i, size);
        } else if (!isEmpty()) {
            Object[] objArr3 = this.A01;
            AnonymousClass025.A06(objArr3, 0, objArr, this.A00, objArr3.length);
            Object[] objArr4 = this.A01;
            AnonymousClass025.A06(objArr4, objArr4.length - this.A00, objArr, 0, size);
        }
        int size2 = size();
        C00C.A0A(objArr, 1);
    ...
    private final void A00(int i) {
        ...
        if (i > length) {
            ...
            Object[] objArr2 = new Object[C0IL.A00(length, i)];
            AnonymousClass025.A06(objArr, 0, objArr2, this.A00, length);
            Object[] objArr3 = this.A01;
            int length2 = objArr3.length;
            int i2 = this.A00;
            AnonymousClass025.A06(objArr3, length2 - i2, objArr2, 0, i2);
            this.A00 = 0;
            this.A01 = objArr2;
        }
    }
    ...
    public int indexOf(Object obj) {
        ...
        if (i < size) {
            while (i < size) {
                if (!C00C.areEqual(obj, this.A01[i])) {
                    i++;
                }
            }
            return -1;
        ...
        while (true) {
            if (i >= length) {
                for (int i2 = 0; i2 < size; i2++) {
                    if (C00C.areEqual(obj, this.A01[i2])) {
    ...
    public int lastIndexOf(Object obj) {
        ...
        if (i < size) {
            length = size - 1;
            if (i <= length) {
                while (!C00C.areEqual(obj, this.A01[length])) {
                    if (length != i) {
                        length--;
                    }
                }
        ...
        if (i > size) {
            while (true) {
                ...
                } else if (C00C.areEqual(obj, objArr[size])) {
    ...
    public Object A0L(int i) {
        ...
        if (i < size) {
            if (i2 >= i3) {
                Object[] objArr2 = this.A01;
                AnonymousClass025.A06(objArr2, i3 + 1, objArr2, i3, i2);
            } else {
                Object[] objArr3 = this.A01;
                AnonymousClass025.A06(objArr3, 1, objArr3, 0, i2);
                Object[] objArr4 = this.A01;
        ...
        if (i3 != 0) {
            ...
            if (i < size) {
                ...
                while (i > 0) {
                    ...
                    i6 -= min;
                    i5 -= min;
                    AnonymousClass025.A06(objArr, i6 + 1, objArr, i5 + 1, i7);
                    if (i5 < 0) {
                        i5 += this.A01.length;
                    }
                    if (i6 < 0) {
    ...
    public boolean addAll(int i, Collection collection) {
        ...
        if (i < ((size() + 1) >> 1)) {
            ...
            if (i2 >= i3) {
                if (i4 >= 0) {
                    Object[] objArr = this.A01;
                    AnonymousClass025.A06(objArr, i4, objArr, i3, i2);
                } else {
                    Object[] objArr2 = this.A01;
                    int length2 = objArr2.length;
                    i4 += length2;
                    ...
                    int i6 = length2 - i4;
                    if (i6 >= i5) {
                        System.arraycopy(objArr2, i3, objArr2, i4, i5);
                    } else {
                        System.arraycopy(objArr2, i3, objArr2, i4, (i3 + i6) - i3);
                        Object[] objArr3 = this.A01;
                        AnonymousClass025.A06(objArr3, 0, objArr3, this.A00 + i6, i2);
                    }
                }
            } else {
                Object[] objArr4 = this.A01;
                System.arraycopy(objArr4, i3, objArr4, i4, objArr4.length - i3);
                Object[] objArr5 = this.A01;
                int length3 = objArr5.length - size2;
                if (size2 >= i2) {
                    System.arraycopy(objArr5, 0, objArr5, length3, i2);
                } else {
                    System.arraycopy(objArr5, 0, objArr5, length3, size2);
                    Object[] objArr6 = this.A01;
                    AnonymousClass025.A06(objArr6, 0, objArr6, size2, i2);
                }
            }
            this.A00 = i4;
            i2 -= size2;
            ...
            if (i2 < size) {
                ...
                if (i8 > length4) {
                    if (i7 >= length4) {
                        ...
                        AnonymousClass025.A06(objArr8, i7, objArr8, i2, size - i9);
                    }
                }
                System.arraycopy(objArr7, i2, objArr7, i7, size - i2);
            } else {
                Object[] objArr9 = this.A01;
                AnonymousClass025.A06(objArr9, size2, objArr9, 0, size);
