...
public class EM6 extends C038707q {
    public final /* synthetic */ AbstractC34645Fbu A00;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EM6(AbstractC34645Fbu abstractC34645Fbu, String str) {
        super(AbstractC34851af.A0q("PhotosDisk-", str, AnonymousClass000.A04()));
    ...
    public void run() {
        ...
        do {
            try {
                ...
                Stack stack = abstractC34645Fbu.A0D;
                synchronized (stack) {
                    try {
                        if (stack.size() == 0) {
                            stack.wait();
