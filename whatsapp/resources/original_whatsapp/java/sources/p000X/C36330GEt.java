...
public final class C36330GEt implements C3V7 {
    ...
    public void Az8(C0PO c0po, C0MA c0ma, int i) {
        ...
        GE2 ge2 = new GE2(c0ma, this, num, A00, 2);
        A0N.get();
        C1CD.A01(c0po, ge2);
    }
    ...
    public static final void A00(C0MA c0ma, C36330GEt c36330GEt, Integer num) {
        if (num.intValue() != 0) {
            AbstractC30168DYb.A0y(c36330GEt.A01, c0ma);
            return;
        }
        C35156Fkz c35156Fkz = (C35156Fkz) c0ma.getIntent().getParcelableExtra("status_call_state");
        if (c35156Fkz != null) {
            ((C1D1) C05V.A02(c36330GEt.A02)).Bhj(c35156Fkz, c0ma);
        }
    }
}
