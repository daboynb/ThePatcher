...
public final class C26874C0b {
    ...
    public final B3M A0I;
    public final CharSequence A0J;
    public final boolean A0K;
    public final boolean A0L;

    public C26874C0b(ColorStateList colorStateList, ColorStateList colorStateList2, Rect rect, Typeface typeface, Drawable drawable, Drawable drawable2, Editable editable, TextUtils.TruncateAt truncateAt, KeyListener keyListener, B3M b3m, CharSequence charSequence, float f, float f2, float f3, float f4, int i, int i2, int i3, int i4, int i5, boolean z, boolean z2) {
        this.A0F = editable;
        this.A03 = f;
