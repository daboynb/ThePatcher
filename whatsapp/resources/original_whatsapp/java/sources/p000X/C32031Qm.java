...
public class C32031Qm extends AbstractC30911Md {
    public Map A00;
    ...
    public String A0k() {
        ...
        try {
            ...
            try {
                ...
                jsonWriter.name("linkPreviewResults").beginObject();
                for (Map.Entry entry : this.A00.entrySet()) {
                    hashMap.put((String) entry.getKey(), (EnumC148396hU) ((Pair) entry.getValue()).first);
                    C1385267d c1385267d = (C1385267d) ((Pair) entry.getValue()).second;
                    if (c1385267d != null) {
                        jsonWriter.name((String) entry.getKey());
                        jsonWriter.value(Base64.encodeToString(c1385267d.toByteArray(), 2));
                    }
                }
            ...
            Log.m221e("FMessagePeerDataLinkPreviewRequestResponse/writeData failed", e);
            return null;
        }
    }
    ...
    public void A0l(String str) {
        ...
        try {
            ...
            try {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (hashCode != -1808687704) {
                        ...
                        sb.append("FMessagePeerDataLinkPreviewRequestResponse/readData/unexpected name \"");
                        sb.append(nextName);
                        sb.append("\"");
                        Log.m230w(sb.toString());
                    } else if (nextName.equals("linkPreviewResults")) {
                        jsonReader.beginObject();
                        while (jsonReader.hasNext()) {
                            hashMap2.put(jsonReader.nextName(), (C1385267d) AbstractC265514n.A05(C1385267d.DEFAULT_INSTANCE, Base64.decode(jsonReader.nextString(), 2)));
                        }
                        jsonReader.endObject();
                    } else {
                        StringBuilder sb2 = new StringBuilder();
                        sb2.append("FMessagePeerDataLinkPreviewRequestResponse/readData/unexpected name \"");
                        sb2.append(nextName);
                        sb2.append("\"");
            ...
            Log.m221e("FMessagePeerDataLinkPreviewRequestResponse/readData failed", e);
        }
