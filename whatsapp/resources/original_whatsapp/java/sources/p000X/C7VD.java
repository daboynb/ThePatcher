...
public final class C7VD implements InterfaceC1853586h {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C7VD) {
                C7VD c7vd = (C7VD) obj;
                if (!C00C.areEqual(this.A00, c7vd.A00) || !C00C.areEqual(this.A03, c7vd.A03) || !C00C.areEqual(this.A04, c7vd.A04) || !C00C.areEqual(this.A02, c7vd.A02) || !C00C.areEqual(this.A01, c7vd.A01) || this.A05 != c7vd.A05) {
                }
            }
            return false;
        }
    ...
    public C7VD(C1613376m c1613376m, AbstractC60612hW abstractC60612hW, List list, Function1 function1, Function1 function12, boolean z) {
        this.A00 = c1613376m;
        this.A03 = function1;
        this.A04 = function12;
        this.A02 = list;
    ...
    public String toString() {
        ...
        A04.append("LinkMessage(messageModel=");
        A04.append(this.A00);
        A04.append(", onClick=");
        A04.append(this.A03);
