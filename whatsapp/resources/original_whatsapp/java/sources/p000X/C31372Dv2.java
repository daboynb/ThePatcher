...
public final class C31372Dv2 extends AbstractC31385DvF {
    ...
    public C31372Dv2(AbstractC32947Eln abstractC32947Eln, Long l, String str, String str2, String str3) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C31372Dv2) {
                C31372Dv2 c31372Dv2 = (C31372Dv2) obj;
                if (!C00C.areEqual(this.A00, c31372Dv2.A00) || !C00C.areEqual(this.A01, c31372Dv2.A01) || !C00C.areEqual(this.A04, c31372Dv2.A04) || !C00C.areEqual(this.A02, c31372Dv2.A02) || !C00C.areEqual(this.A03, c31372Dv2.A03)) {
                }
            }
            return false;
        }
