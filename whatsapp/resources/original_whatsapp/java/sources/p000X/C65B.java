...
public final class C65B extends AbstractC265514n implements InterfaceC265314j {
    public static final int AXOLOTL_SENDER_KEY_DISTRIBUTION_MESSAGE_FIELD_NUMBER = 2;
    public static final C65B DEFAULT_INSTANCE;
    ...
    static {
        C65B c65b = new C65B();
        DEFAULT_INSTANCE = c65b;
        AbstractC265514n.A0B(c65b, C65B.class);
    }

    public static C65B parseFrom(ByteBuffer byteBuffer) {
        return (C65B) AbstractC265514n.A04(DEFAULT_INSTANCE, byteBuffer);
    }
        ...
        switch (anonymousClass157) {
            ...
            case NEW_BUILDER:
                return new AnonymousClass159() { // from class: X.61S
                    {
                        C65B c65b = C65B.DEFAULT_INSTANCE;
                    }
                };
