...
public class C27372CKi {
    ...
    public static void A00(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        ...
        if (d18 < 0.0d) {
            ...
            A04.append("Points are too far apart ");
            A04.append(d17);
            Log.w("PathParser", A04.toString());
    ...
    public C27372CKi(float[] fArr, char c) {
        this.A00 = c;
        this.A01 = fArr;
    }

    public C27372CKi(C27372CKi c27372CKi) {
        this.A00 = c27372CKi.A00;
        float[] fArr = c27372CKi.A01;
