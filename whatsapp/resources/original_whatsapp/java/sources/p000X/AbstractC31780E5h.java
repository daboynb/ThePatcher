...
public abstract class AbstractC31780E5h extends GPO implements List, RandomAccess {
    public static final AbstractC31776E5d A00 = new C31775E5c(E5Z.A02, 0);
    ...
    public AbstractC31780E5h subList(int i, int i2) {
        if (!(this instanceof E5X)) {
            IXO.A02(i, i2, size());
            int i3 = i2 - i;
            return i3 == size() ? this : i3 == 0 ? E5Z.A02 : new E5X(this, i, i3);
        }
        E5X e5x = (E5X) this;
        IXO.A02(i, i2, e5x.A01);
        int i4 = e5x.A00;
        return e5x.zzc.subList(i + i4, i2 + i4);
    }

    @Override // java.util.List
    /* renamed from: A04, reason: merged with bridge method [inline-methods] */
    public final AbstractC31776E5d listIterator(int i) {
        int size = size();
        if (i < 0 || i > size) {
            throw new IndexOutOfBoundsException(IXO.A00(i, size, "index"));
        }
        return isEmpty() ? A00 : new C31775E5c(this, i);
    }
