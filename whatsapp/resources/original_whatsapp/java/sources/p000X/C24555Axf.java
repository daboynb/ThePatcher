...
public final class C24555Axf extends COs implements DX7 {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C24555Axf(JSONObject jSONObject) {
        super(jSONObject);
    ...
    @Override // p000X.DX7
    public InterfaceC30141DWy AQc() {
        return (InterfaceC30141DWy) A06(C24554Axe.class, "bank_info");
    }
