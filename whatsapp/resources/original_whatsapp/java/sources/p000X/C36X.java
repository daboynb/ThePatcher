...
public final class C36X implements InterfaceC31091Mv {
    ...
    public AbstractC39141hs AFw(Context context, InterfaceC78113Vf interfaceC78113Vf, C36501dQ c36501dQ, C1J0 c1j0) {
        ...
        if (c1j0 instanceof C1RN) {
            return new AnonymousClass278(context, interfaceC78113Vf, (C1RN) c1j0);
        }
        String A0z = AbstractC34881ai.A0z(c1j0);
        String name = C1RN.class.getName();
        String str = "".toString();
