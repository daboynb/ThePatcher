...
public final class C31340DuW extends AbstractC31394DvO {
    ...
    public C31340DuW(AbstractC32947Eln abstractC32947Eln, String str, String str2, String str3, String str4) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C31340DuW) {
                C31340DuW c31340DuW = (C31340DuW) obj;
                if (!C00C.areEqual(this.A00, c31340DuW.A00) || !C00C.areEqual(this.A04, c31340DuW.A04) || !C00C.areEqual(this.A01, c31340DuW.A01) || !C00C.areEqual(this.A02, c31340DuW.A02) || !C00C.areEqual(this.A03, c31340DuW.A03)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        A04.append("FileNotFoundError(name=");
