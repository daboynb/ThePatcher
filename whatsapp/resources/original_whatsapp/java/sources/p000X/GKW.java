...
public class GKW implements X509TrustManager, InterfaceC37196Ghn, InterfaceC37157Ggz {
    public final InterfaceC37196Ghn A00;
    ...
    public void ADT(X509Certificate[] x509CertificateArr, String str, boolean z) {
        InterfaceC37196Ghn interfaceC37196Ghn = this.A00;
        if (!(interfaceC37196Ghn instanceof InterfaceC37157Ggz)) {
            ADS(x509CertificateArr, str);
            return;
        }
        try {
            ((InterfaceC37157Ggz) interfaceC37196Ghn).ADT(x509CertificateArr, str, z);
        } catch (CertificateException unused) {
            this.A04.checkServerTrusted(x509CertificateArr, "ECDHE_ECDSA", str);
        }
    }
    ...
    public GKW(InterfaceC37196Ghn interfaceC37196Ghn) {
        this.A02 = interfaceC37196Ghn;
        try {
