...
public final /* synthetic */ class GMF implements C14X, InterfaceC36779GaD {
    public static final GMF A00 = new GMF();

    @Override // p000X.C14X
    public final C00g AaT() {
        return new C042509k(1, ER3.class, "incImagineRegenerateSent", "incImagineRegenerateSent()Z", 0);
    }
    ...
    public /* bridge */ /* synthetic */ boolean BBT(ThreadInteractionData threadInteractionData) {
        GAR.A00(threadInteractionData).A0D(EnumC32795Ej2.A0B.key);
        return true;
    }
