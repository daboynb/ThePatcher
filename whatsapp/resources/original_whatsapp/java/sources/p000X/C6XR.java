...
public final class C6XR extends C6XV {
    public C0IB A00;
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C6XR) {
                C6XR c6xr = (C6XR) obj;
                if (!C00C.areEqual(this.A02, c6xr.A02) || this.A01 != c6xr.A01 || !C00C.areEqual(this.A00, c6xr.A00) || this.A03 != c6xr.A03) {
                }
            }
            return false;
        }
    ...
    public C6XR(C0IB c0ib, C1599070v c1599070v, int i, boolean z) {
    ...
    public String toString() {
        ...
        A04.append("AddNewsletterStatusDataItem(myStatusState=");
        A04.append(this.A02);
        A04.append(", photoId=");
        A04.append(this.A01);
        A04.append(", contact=");
