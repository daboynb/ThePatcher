...
public abstract class FPZ {
    public static final C34459FTy A00 = new C34459FTy("PhoneskyVerificationUtils");
    ...
    public static boolean A00(Signature[] signatureArr) {
        ...
        c34459FTy.A02(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", objArr), new Object[0]);
        return false;
    }
}
