...
public final class AG2 implements Runnable {
    ...
    public AG2(C15940jy c15940jy, AZG azg, C217089j7 c217089j7, A36 a36, PublicKey publicKey, X509Certificate x509Certificate, int i) {
    ...
    public void run() {
        ...
        a36.Bp6(c15940jy, this.A02, this.A03, Integer.valueOf(this.A00), publicKey, x509Certificate);
    }
}
