...
public final /* synthetic */ class GMC implements C14X, InterfaceC36779GaD {
    public static final GMC A00 = new GMC();

    @Override // p000X.C14X
    public final C00g AaT() {
        return new C042509k(1, ER3.class, "incImagineMeQueryPrompts", "incImagineMeQueryPrompts()Z", 0);
    }
    ...
    public /* bridge */ /* synthetic */ boolean BBT(ThreadInteractionData threadInteractionData) {
        GAR.A00(threadInteractionData).A0D(EnumC32795Ej2.A07.key);
        return true;
    }
