...
public final class C7VB implements InterfaceC1853586h {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C7VB) {
                C7VB c7vb = (C7VB) obj;
                if (!C00C.areEqual(this.A00, c7vb.A00) || !C00C.areEqual(this.A03, c7vb.A03) || !C00C.areEqual(this.A04, c7vb.A04) || !C00C.areEqual(this.A02, c7vb.A02) || !C00C.areEqual(this.A01, c7vb.A01) || this.A05 != c7vb.A05) {
                }
            }
            return false;
        }
    ...
    public C7VB(C1613376m c1613376m, AbstractC60612hW abstractC60612hW, List list, Function1 function1, Function1 function12, boolean z) {
        this.A00 = c1613376m;
        this.A03 = function1;
        this.A04 = function12;
        this.A02 = list;
    ...
    public String toString() {
        ...
        A04.append("DocumentMessage(messageModel=");
        A04.append(this.A00);
        A04.append(", onClick=");
        A04.append(this.A03);
