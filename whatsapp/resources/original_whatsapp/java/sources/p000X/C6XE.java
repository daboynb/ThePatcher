...
public final class C6XE extends C6XP {
    public C0IB A00;
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C6XE) {
                C6XE c6xe = (C6XE) obj;
                if (!C00C.areEqual(this.A06, c6xe.A06) || this.A01 != c6xe.A01 || !C00C.areEqual(this.A00, c6xe.A00) || !C00C.areEqual(this.A04, c6xe.A04) || !C00C.areEqual(this.A07, c6xe.A07) || this.A08 != c6xe.A08 || !C00C.areEqual(this.A03, c6xe.A03) || !C00C.areEqual(this.A05, c6xe.A05) || !C00C.areEqual(this.A02, c6xe.A02)) {
                }
            }
            return false;
        }
    ...
    public C6XE(C0IB c0ib, InterfaceC1855186y interfaceC1855186y, InterfaceC1855186y interfaceC1855186y2, InterfaceC1855186y interfaceC1855186y3, C75S c75s, C1599070v c1599070v, CharSequence charSequence, int i, boolean z) {
    ...
    public String toString() {
        ...
        A04.append("MyGroupStatusDataItem(myStatusState=");
        A04.append(this.A06);
        A04.append(", photoId=");
        A04.append(this.A01);
        A04.append(", contact=");
