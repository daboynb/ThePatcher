...
public abstract class AbstractC106364ng {
    public static Function1 A00 = C120275Rt.A00;
    ...
    public static final void A01(float[] fArr, float[] fArr2) {
        ...
        fArr[3] = A005;
        fArr[4] = A006;
        C3WI.A1R(fArr, A007, A008, A009);
        C3WJ.A0y(fArr, A0010, A0011, A0012, A0013);
        C3WI.A1S(fArr, A0014, A0015, A0016);
        fArr[15] = A0017;
    }
