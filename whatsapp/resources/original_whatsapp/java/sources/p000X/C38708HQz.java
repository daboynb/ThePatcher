...
public class C38708HQz extends EOH {
    public final int $t;
    public final Object A00;
    public final Object A01;

    public C38708HQz(C0SZ c0sz, EQD eqd, int i) {
        this.$t = i;
        if (i != 0) {
            C00C.A0A(eqd, 1);
            ...
            interfaceC36764GZvArr[0] = new C42631J9x(iy9, 12);
            interfaceC36764GZvArr[1] = new C42631J9x(iy9, 13);
            interfaceC36764GZvArr[2] = new C42631J9x(iy9, 14);
            interfaceC36764GZvArr[3] = new C42631J9x(iy9, 15);
            Object A0C = c34717FdU2.A0C(c0sz, "IQErrorInternalServerError|IQErrorBadRequest|IQErrorForbidden|IQErrorRateOverlimit|IQErrorReportTokenValidationFail", AbstractC34801aa.A1F(new C42631J9x(iy9, 16), interfaceC36764GZvArr, 4), new String[]{"error"});
            if (A0C == null) {
                throw C87V.A0Z(c34717FdU2);
            }
            this.A00 = A0C;
