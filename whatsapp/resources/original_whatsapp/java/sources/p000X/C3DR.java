...
public final class C3DR implements C3VU, C3V5 {
    public final C05V A00 = AbstractC34811ab.A0b();

    public static Boolean A01(C1J0 c1j0, C3DR c3dr) {
        C00C.A0A(c1j0, 0);
        if (c3dr.A00(c1j0) != null) {
    ...
    private final Boolean A00(C1J0 c1j0) {
        if (!AbstractC34831ad.A1Z(c1j0) && AbstractC39061hk.A0A(c1j0) && ((C0V7) C05V.A02(this.A00)).A04()) {
