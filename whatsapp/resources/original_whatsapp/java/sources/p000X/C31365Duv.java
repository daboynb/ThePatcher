...
public final class C31365Duv extends AbstractC31351Duh {
    ...
    public C31365Duv(AbstractC32947Eln abstractC32947Eln, String str, List list, int i, long j, long j2, long j3, long j4, long j5) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C31365Duv) {
                C31365Duv c31365Duv = (C31365Duv) obj;
                if (!C00C.areEqual(this.A06, c31365Duv.A06) || !C00C.areEqual(this.A07, c31365Duv.A07) || this.A05 != c31365Duv.A05 || this.A02 != c31365Duv.A02 || this.A01 != c31365Duv.A01 || this.A04 != c31365Duv.A04 || !C00C.areEqual(this.A08, c31365Duv.A08) || this.A00 != c31365Duv.A00 || this.A03 != c31365Duv.A03) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        A04.append("FirstOnPauseEvent(name=");
