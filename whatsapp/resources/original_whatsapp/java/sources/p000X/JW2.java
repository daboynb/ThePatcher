...
public final class JW2<E> extends AbstractC07490Oy<E> implements PersistentList.Builder<E>, Collection, C0LW, InterfaceC07480Ox {
    public int A00;
    public int A01;
    public C39358HiR A02 = new C39358HiR();
    public Object[] A03;
    public Object[] A04;
    public InterfaceC127755ih A05;
    public Object[] A06;
    public Object[] A07;

    private final int A01(C39219Hg5 c39219Hg5, List list, List list2, Function1 function1, Object[] objArr, int i, int i2) {
    ...
    private final void A07(Object[] objArr, int i, int i2) {
        if (i2 == 0) {
            ...
            c39219Hg5.A00 = null;
            C00C.A09(objArr);
            Object[] A0C = A0C(c39219Hg5, objArr, i2, i);
            C00C.A09(A0C);
            Object obj = c39219Hg5.A00;
            C00C.A0C(obj, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
            this.A04 = (Object[]) obj;
    ...
    private final Object[] A0H(Object[] objArr, int i, int i2) {
        if (i2 < 0) {
            throw AbstractC34801aa.A0y("shift should be positive");
        }
        if (i2 == 0) {
            return objArr;
        }
    ...
    private final Object[] A0J(Object[] objArr, Object[][] objArr2, int i) {
        ...
        int i2 = i >> 5;
        int i3 = this.A00;
        Object[] A0E = i2 < (1 << i3) ? A0E(A16, objArr, i, i3) : A0F(objArr);
        while (A16.hasNext()) {
            int i4 = this.A00 + 5;
            this.A00 = i4;
    ...
    public boolean removeAll(Collection collection) {
        return A0O(new C43139Jah(collection, 1));
    }
    ...
    public Object set(int i, Object obj) {
        ...
        if (A00() > i) {
            ...
            C00C.A09(objArr);
            this.A03 = A0B(c39219Hg5, obj, objArr, this.A00, i);
            return c39219Hg5.A00;
        }
    ...
    private final int A02(C39219Hg5 c39219Hg5, Function1 function1, int i) {
    ...
    private final JL4 A03(int i) {
        Object[] objArr = this.A03;
        if (objArr == null) {
            throw AbstractC34801aa.A0z("Invalid root");
        }
        int A00 = A00() >> 5;
        IKC.A01(i, A00);
        int i2 = this.A00;
        return i2 == 0 ? new C37498GoI(objArr, i) : new C37500GoK(objArr, i, A00, i2 / 5);
    }
    ...
    private final Object[] A0A(C39219Hg5 c39219Hg5, Object obj, Object[] objArr, int i, int i2) {
        Object obj2;
        int i3 = (i2 >> i) & 31;
        if (i == 0) {
        ...
        while (true) {
            A0F2[i3] = A0A(c39219Hg5, obj, A1a, i4, i2);
            i3++;
    ...
    private final Object[] A0B(C39219Hg5 c39219Hg5, Object obj, Object[] objArr, int i, int i2) {
        int i3 = (i2 >> i) & 31;
        Object[] A0F = A0F(objArr);
        if (i != 0) {
            A0F[i3] = A0B(c39219Hg5, obj, AbstractC37202Gi1.A1a(A0F, i3), i - 5, i2);
            return A0F;
        }
        if (A0F != objArr) {
            ((AbstractList) this).modCount++;
        }
        c39219Hg5.A00 = A0F[i3];
        A0F[i3] = obj;
        return A0F;
    }
    ...
    */
    private final Object[] A0C(C39219Hg5 c39219Hg5, Object[] objArr, int i, int i2) {
        Object[] A0C;
        int i3 = ((i2 - 1) >> i) & 31;
        if (i == 5) {
            ...
            A0C = A0C(c39219Hg5, AbstractC37202Gi1.A1a(objArr, i3), i - 5, i2);
        }
        if (i3 == 0) {
            return null;
        }
    ...
    private final Object[] A0D(C39219Hg5 c39219Hg5, Object[] objArr, int i, int i2) {
        int i3 = (i2 >> i) & 31;
        if (i == 0) {
            Object obj = objArr[i3];
            Object[] A0F = A0F(objArr);
            AnonymousClass025.A06(objArr, i3, A0F, i3 + 1, 32);
            A0F[31] = c39219Hg5.A00;
            c39219Hg5.A00 = obj;
            return A0F;
        }
        ...
        if (i5 <= A00) {
            while (true) {
                ...
                A0F2[A00] = A0D(c39219Hg5, (Object[]) obj2, i4, 0);
                if (A00 == i5) {
                    break;
                }
                A00--;
        ...
        A0F2[i3] = A0D(c39219Hg5, (Object[]) obj3, i4, i2);
        return A0F2;
    }
    ...
    public InterfaceC127755ih A0N() {
        InterfaceC127755ih c37503GoN;
        InterfaceC127755ih interfaceC127755ih;
        Object[] objArr = this.A03;
        if (objArr == this.A06 && this.A04 == this.A07) {
            interfaceC127755ih = this.A05;
        } else {
            this.A02 = new C39358HiR();
            this.A06 = objArr;
            Object[] objArr2 = this.A04;
            this.A07 = objArr2;
            if (objArr != null) {
                c37503GoN = new C37503GoN(objArr, objArr2, size(), this.A00);
            } else if (objArr2.length == 0) {
                interfaceC127755ih = C37502GoM.A01;
            } else {
                c37503GoN = new C37502GoM(AbstractC37201Gi0.A1b(objArr2, size()));
            }
            interfaceC127755ih = c37503GoN;
        }
        this.A05 = interfaceC127755ih;
        return interfaceC127755ih;
    }
    ...
    public final boolean A0O(Function1 function1) {
        ...
        c39219Hg5.A00 = null;
        if (this.A03 == null) {
            A02 = A02(c39219Hg5, function1, A0F);
        } else {
            JL4 A03 = A03(0);
            while (A03.hasNext()) {
                Object[] objArr = (Object[]) A03.next();
                int i2 = 0;
                Object[] objArr2 = objArr;
                int i3 = 32;
                boolean z = false;
                ...
                c39219Hg5.A00 = objArr2;
                if (i3 != 32) {
                    int previousIndex = A03.previousIndex() << 5;
                    ArrayList A16 = AbstractC34801aa.A16();
                    ArrayList A162 = AbstractC34801aa.A16();
                    while (A03.hasNext()) {
                        i3 = A01(c39219Hg5, A162, A16, function1, (Object[]) A03.next(), 32, i3);
                    }
                    int A01 = A01(c39219Hg5, A162, A16, function1, this.A04, A0F, i3);
                    Object obj2 = c39219Hg5.A00;
                    C00C.A0C(obj2, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
                    ...
                    if (isEmpty) {
                        ...
                        objArr4 = A0E(A16.iterator(), objArr4, previousIndex, this.A00);
                    }
                    int size = previousIndex + (A16.size() << 5);
                    if ((size & 31) != 0) {
                        throw AbstractC34801aa.A0y("invalid size");
                    }
                    if (size == 0) {
                        this.A00 = 0;
                        A0H = null;
    ...
    public JW2(InterfaceC127755ih interfaceC127755ih, Object[] objArr, Object[] objArr2, int i) {
        this.A05 = interfaceC127755ih;
        this.A06 = objArr;
        this.A07 = objArr2;
        this.A00 = i;
        this.A03 = objArr;
        this.A04 = objArr2;
        this.A01 = interfaceC127755ih.size();
    }
    ...
    private final void A05(Object obj, Object[] objArr, int i) {
        ...
        Object[] A0F = A0F(this.A04);
        if (size < 32) {
            AnonymousClass025.A06(this.A04, i + 1, A0F, i, size);
            A0F[i] = obj;
            this.A03 = objArr;
            this.A04 = A0F;
            this.A01 = size() + 1;
    ...
    public Object A0L(int i) {
        ...
        Object[] objArr = this.A03;
        C00C.A09(objArr);
        A04(A0D(c39219Hg5, objArr, this.A00, i), A00, this.A00, 0);
        return c39219Hg5.A00;
    }
    ...
    public void add(int i, Object obj) {
        ...
        Object[] objArr = this.A03;
        C00C.A09(objArr);
        A05(c39219Hg5.A00, A0A(c39219Hg5, obj, objArr, this.A00, i), 0);
    }
        ...
        if (A0J == 0) {
            ...
            if (i >= A00()) {
                ...
                if (this.A03 != null) {
                    ...
                    int i7 = A0J;
                    JL4 A03 = A03(A00() >> 5);
                    while (A03.previousIndex() != i3) {
                        Object[] objArr6 = (Object[]) A03.previous();
                        AnonymousClass025.A06(objArr6, 0, objArr5, 32 - i2, 32);
                        objArr5 = A0G(objArr6, i2);
                        i7--;
                        objArr3[i7] = objArr5;
                    }
                    objArr = (Object[]) A03.previous();
                    ...
                    throw AbstractC34801aa.A0z("root is null");
                }
            }
            if (A0J >= 1) {
                Object[] A0F2 = A0F(objArr);
                ...
                throw AbstractC34801aa.A0y("requires at least one nullBuffer");
            }
        }
        this.A01 = AbstractC37200Ghz.A0J(collection, size());
        return true;
