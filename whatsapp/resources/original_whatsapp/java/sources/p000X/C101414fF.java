...
public final class C101414fF {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C101414fF) {
                C101414fF c101414fF = (C101414fF) obj;
                if (!C00C.areEqual(this.A04, c101414fF.A04) || !C00C.areEqual(this.A02, c101414fF.A02) || !C00C.areEqual(this.A01, c101414fF.A01) || !C00C.areEqual(this.A00, c101414fF.A00) || !C00C.areEqual(this.A03, c101414fF.A03)) {
                }
            }
            return false;
        }
    ...
    public C101414fF(String str, String str2, String str3, String str4, String str5) {
        this.A04 = str;
        this.A02 = str2;
        this.A01 = str3;
        this.A00 = str4;
