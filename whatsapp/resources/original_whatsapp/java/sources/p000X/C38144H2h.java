...
public class C38144H2h extends AbstractRunnableC42739JFx {
    ...
    public C38144H2h(DataTask dataTask, NetworkSession networkSession, UrlResponse urlResponse, File file, IOException iOException, byte[] bArr) {
    ...
    public void run() {
        ...
        try {
            try {
                ...
                AnonymousClass062.A0G("wa-msys/NetworkSession: ", "IOException while executing markDataTaskCompleted", e);
