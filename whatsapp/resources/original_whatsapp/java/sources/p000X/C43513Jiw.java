...
public class C43513Jiw extends AbstractC43516Jiz {
    public int A00 = -1;
    ...
    public int A0D() {
        ...
        if (i < 0) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                i = AbstractC37204Gi3.A0L(super.A00, i2, i);
            }
            this.A00 = i;
        }
    ...
    public void A0G(C41213IbC c41213IbC, boolean z) {
        ...
        if (i < 0) {
            ...
            i = 0;
            do {
                i = AbstractC37204Gi3.A0L(super.A00, i5, i);
                i5++;
            } while (i5 < length);
            this.A00 = i;
        }
        c41213IbC.A03(i);
        while (i2 < length) {
            c41213IbC2.A04(super.A00[i2].CAd(), true);
            i2++;
        }
    }
}
