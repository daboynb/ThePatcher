...
public final class C44F extends AbstractC2053797m {
    ...
    public void A02(JSONObject jSONObject, long j) {
        ...
        if (jSONObject != null) {
            ...
            try {
                JSONObject jSONObject2 = jSONObject.getJSONObject("xwa_genai_imagine_animate_for_intents_wa");
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    if (jSONObject3.has("imagine_result_success")) {
                        ...
                        if (A04 == null || A042 == null || A043 == null || A044 == null || A045 == null || A00 == null) {
                            A0q = "ImagineAnimateDataProcessor null response when parsing data key data";
                            Log.m219e(A0q);
                        } else {
                            A16.add(new C45Z(A04, A042, A043, A045, "", A00.booleanValue(), ""));
                        }
                    } else if (jSONObject3.has("message")) {
                        A0q = AbstractC34851af.A0q("ImagineAnimateDataProcessor received error on RootResponse/", jSONObject3.getString("message"), AnonymousClass000.A04());
                        Log.m219e(A0q);
                    }
                }
            } catch (JSONException e) {
                AbstractC34851af.A1C(e, "ImagineAnimateDataProcessor JsonParsingException on RootResponse/", AnonymousClass000.A04());
            }
            this.A00 = new C937545d(A16);
        }
    }
}
