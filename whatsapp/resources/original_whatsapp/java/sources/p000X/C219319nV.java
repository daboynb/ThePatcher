...
public final class C219319nV {
    public static C219319nV A01;
    ...
    public final boolean A02() {
        ...
        try {
            packageInfo = C13440fg.A00(this.A00).A00.getPackageManager().getPackageInfo("com.google.android.wearable.app.cn", 64);
    ...
    public C219319nV(Context context) {
        this.A00 = context.getApplicationContext();
    }

    public static C219319nV A00(Context context) {
        AnonymousClass010.A00(context);
        synchronized (C219319nV.class) {
            if (A01 == null) {
                A01 = new C219319nV(context);
            }
        }
        return A01;
    }
