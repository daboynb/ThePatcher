...
public final class C31368Duy extends AbstractC31385DvF {
    ...
    public C31368Duy(AbstractC32947Eln abstractC32947Eln, Long l, String str, String str2, String str3) {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C31368Duy) {
                C31368Duy c31368Duy = (C31368Duy) obj;
                if (!C00C.areEqual(this.A00, c31368Duy.A00) || !C00C.areEqual(this.A01, c31368Duy.A01) || !C00C.areEqual(this.A04, c31368Duy.A04) || !C00C.areEqual(this.A02, c31368Duy.A02) || !C00C.areEqual(this.A03, c31368Duy.A03)) {
                }
            }
            return false;
        }
    ...
    public String toString() {
        ...
        A04.append("AMPDetectPrefix(name=");
