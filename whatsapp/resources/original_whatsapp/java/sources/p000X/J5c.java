...
public final class J5c implements InterfaceC43957Jss {
    public final HCR A00;
    ...
    public byte[] AHu(final byte[] ciphertext, final byte[] associatedData) {
        ...
        return this.A00.A04(ByteBuffer.wrap(ciphertext, 24, length2 - 24), copyOf, associatedData);
    }

    public J5c(final byte[] key, final byte[] outputPrefix) {
        this.A00 = new HCR(key);
