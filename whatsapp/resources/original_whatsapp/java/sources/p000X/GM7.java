...
public final /* synthetic */ class GM7 implements C14X, InterfaceC36779GaD {
    public static final GM7 A00 = new GM7();

    @Override // p000X.C14X
    public final C00g AaT() {
        return new C042509k(1, ER3.class, "incImagineAnimatedEditedSent", "incImagineAnimatedEditedSent()Z", 0);
    }
    ...
    public /* bridge */ /* synthetic */ boolean BBT(ThreadInteractionData threadInteractionData) {
        GAR.A00(threadInteractionData).A0D(EnumC32795Ej2.A04.key);
        return true;
    }
