...
public final class C218869mc {
    ...
    public final void A05(List list, List list2) {
        ...
        try {
            ...
            c0l3.A04("status_crossposting_v3", AbstractC34911al.A0c(AbstractC1855387a.A0B("status_message_row_id IN  (", A042, size, size2), A042), "[WAFFLE] WaffleStatusCrosspostingStore/DELETE_CROSSPOSTING_COLUMN_BY_MESSAGE_AND_DESTINATION_IDS", AbstractC34881ai.A1b(A16, 0));
            A04.close();
        } finally {
        }
    }

    public static final void A00(ContentValues contentValues, C1RF c1rf, C218869mc c218869mc, List list) {
        C21330t1 A04 = c218869mc.A01.A04();
        try {
            C0L3 c0l3 = A04.A02;
            int size = list.size();
            StringBuilder A042 = AnonymousClass000.A04();
            C87Y.A1B(",", C87Y.A0s("status_message_row_id IN  (", A042, size), A042);
            String A03 = AnonymousClass000.A03(") AND destination = ?", A042);
    ...
    public static final void A01(ContentValues contentValues, C218869mc c218869mc, List list) {
        C21330t1 A04 = c218869mc.A01.A04();
        try {
            C0L3 c0l3 = A04.A02;
            int size = list.size();
            StringBuilder A042 = AnonymousClass000.A04();
            String A0c = AbstractC34911al.A0c(AbstractC34891aj.A0l(",", C87Y.A0s("status_message_row_id IN  (", A042, size)), A042);
            ArrayList A0G = C09Q.A0G(list);
            Iterator it = list.iterator();
            while (it.hasNext()) {
                C87Z.A1P(A0G, it);
    ...
    public final C199488p5 A02() {
        InterfaceC024600q interfaceC024600q = this.A00.A00;
        ((AbstractC218949mp) interfaceC024600q.get()).A02();
        return (C199488p5) interfaceC024600q.get();
    }
    ...
    public final void A03(String str, List list, int i, long j) {
        ...
        while (it.hasNext()) {
            ...
            C21330t1 A04 = this.A01.A04();
            try {
                A04.A02.A09("status_crossposting_v3", "[WAFFLE] WaffleStatusCrosspostingStore/INSERT_CROSSPOSTING_RECORDS", A03, 4);
                A04.close();
            } finally {
            }
        }
    ...
    public final void A06(List list, List list2, int i) {
        ...
        try {
            ...
            int size2 = list2.size();
            StringBuilder A042 = AnonymousClass000.A04();
            c0l3.A02(A03, "status_crossposting_v3", AbstractC34911al.A0c(AbstractC1855387a.A0B("status_message_row_id IN  (", A042, size, size2), A042), "[WAFFLE] WaffleStatusCrosspostingStore/UPDATE_CROSSPOSTING_COLUMN_BY_MESSAGE_ROW_IDS", AbstractC34881ai.A1b(A16, 0));
            A04.close();
        } finally {
        }
    }
