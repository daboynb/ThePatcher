...
public final class IFE {
    ...
    public IFE() {
        ...
        if (eGLContext2 == EGL14.EGL_NO_CONTEXT) {
            int[] iArr2 = {12324, 8, 12323, 8, 0, 0, 0, 8, 12325, 24, 0, 0, 12344, 0, 12344};
            AbstractC37204Gi3.A1P(iArr2);
            AbstractC37200Ghz.A1P(iArr2, 12352, 4);
            ...
            if (EGL14.eglChooseConfig(this.A02, iArr2, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                ...
                A04.append(2);
                Log.w("MsqrdEglCore", AnonymousClass000.A03(" EGLConfig", A04));
            }
        ...
        Log.i("MsqrdEglCore", AbstractC34811ab.A1L(A042, iArr3[0]));
    }
