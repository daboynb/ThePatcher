...
public final class C8VO extends AbstractC265514n implements InterfaceC265314j {
    public static final C8VO DEFAULT_INSTANCE;
    ...
    static {
        C8VO c8vo = new C8VO();
        DEFAULT_INSTANCE = c8vo;
        AbstractC265514n.A0B(c8vo, C8VO.class);
    }

    public static C8VO parseFrom(ByteBuffer byteBuffer) {
        return (C8VO) AbstractC265514n.A04(DEFAULT_INSTANCE, byteBuffer);
    }
        ...
        switch (anonymousClass157) {
            ...
            case NEW_BUILDER:
                return new AnonymousClass159() { // from class: X.8SY
                    {
                        C8VO c8vo = C8VO.DEFAULT_INSTANCE;
                    }
                };
