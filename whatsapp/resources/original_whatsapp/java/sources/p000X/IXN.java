...
public abstract class IXN {
    public static String A00(int i, int i2, String str) {
        ...
        return AbstractC39570Hly.A00(str2, A1b);
    }
    ...
    public static void A01(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            ...
            throw AbstractC37199Ghy.A0X(AbstractC39570Hly.A00(str, objArr));
        }
    }
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                if (i2 < 0 || i2 > i3) {
                    ...
                    A00 = AbstractC39570Hly.A00("end index (%s) must not be less than start index (%s)", A1Z);
                }
