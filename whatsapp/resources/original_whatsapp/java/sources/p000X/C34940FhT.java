...
public final class C34940FhT implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < A01) {
            ...
            if (c == 2) {
                ...
                latLng3 = AbstractC34737Fdy.A0D(parcel, readInt);
            } else if (c == 5) {
                latLng4 = AbstractC34737Fdy.A0D(parcel, readInt);
            } else if (c != 6) {
        ...
        return new E2R(latLng, latLng2, latLng3, latLng4, latLngBounds);
    }
}
