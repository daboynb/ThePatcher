...
public class C43502Jil extends C0FC implements InterfaceC43910Jru {
    ...
    public boolean A0J(C0FC c0fc) {
        if (c0fc instanceof C43502Jil) {
            return Arrays.equals(this.A00, ((C43502Jil) c0fc).A00);
        }
        return false;
    }
