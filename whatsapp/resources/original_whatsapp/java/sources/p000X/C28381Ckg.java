...
public class C28381Ckg implements DPQ {
    public final int $t;

    public C28381Ckg(int i) {
        this.$t = i;
    }
    ...
    public List AWd(Editable editable, C85 c85) {
        ...
        switch (this.$t) {
            ...
            case 1:
                ...
                break;
            case 2:
                boolean A1Z2 = AbstractC34911al.A1Z(editable, c85);
            ...
            case 3:
                boolean A1Z3 = AbstractC34911al.A1Z(editable, c85);
                Pattern A152 = AbstractC23468Abr.A15("(^> ?)(.*?$)");
                int i4 = c85.A01;
                Matcher A0y4 = AbstractC23469Abs.A0y(editable, A152, i4, c85.A00);
                A02 = AbstractC025401a.A02();
                while (A0y4.find()) {
                ...
                break;
            case 4:
                boolean A1Z4 = AbstractC34911al.A1Z(editable, c85);
                Pattern A153 = AbstractC23468Abr.A15("(^ *([1-9][0-9]?)\\.\\s ?)(.*?$)");
                int i5 = c85.A01;
                Matcher A0y5 = AbstractC23469Abs.A0y(editable, A153, i5, c85.A00);
                A02 = AbstractC025401a.A02();
                while (A0y5.find()) {
                ...
                break;
            default:
                boolean A1Z5 = AbstractC34911al.A1Z(editable, c85);
                Pattern A154 = AbstractC23468Abr.A15("(^([1-9][0-9]?)\\.\\s ?)(.*?$)");
                int i6 = c85.A01;
                Matcher A0y6 = AbstractC23469Abs.A0y(editable, A154, i6, c85.A00);
                A02 = AbstractC025401a.A02();
                while (A0y6.find()) {
