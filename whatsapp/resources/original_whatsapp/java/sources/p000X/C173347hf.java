...
public final class C173347hf implements InterfaceC1843582i, InterfaceC1843682j, C87B {
    ...
    public /* bridge */ /* synthetic */ void ABp(AbstractC172747gc abstractC172747gc, C78B c78b) {
        C6NQ c6nq = (C6NQ) abstractC172747gc;
        C00C.A0A(c6nq, 0);
        C6L1 c6l1 = c6nq.A00;
        if (c6l1 == null) {
            throw C148996iU.A04("FStatusReshareProtobuf/buildStatusNotification Invalid message originalKeyIsNull: true", 0);
        }
        ((C72W) C05V.A02(this.A01)).A01(c6nq.A01, c6l1, c6nq, c78b);
    }
    ...
    public /* bridge */ /* synthetic */ AbstractC172747gc Bol(AnonymousClass771 anonymousClass771) {
        ...
        if (forNumber != EnumC148366hR.A03) {
            return null;
        }
        ...
        return new C6NQ(anonymousClass781.A01(c142186Ma), c6l12, c6l1, null, A03.A0I, A09, c142186Ma.A07);
    }
}
