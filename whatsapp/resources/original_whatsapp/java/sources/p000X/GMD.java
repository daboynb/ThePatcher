...
public final /* synthetic */ class GMD implements C14X, InterfaceC36779GaD {
    public static final GMD A00 = new GMD();

    @Override // p000X.C14X
    public final C00g AaT() {
        return new C042509k(1, ER3.class, "incImagineMessagesSent", "incImagineMessagesSent()Z", 0);
    }
    ...
    public /* bridge */ /* synthetic */ boolean BBT(ThreadInteractionData threadInteractionData) {
        GAR.A00(threadInteractionData).A0D(EnumC32795Ej2.A09.key);
        return true;
    }
