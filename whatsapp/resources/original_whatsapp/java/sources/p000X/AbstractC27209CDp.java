...
public abstract class AbstractC27209CDp {
    ...
    public static Rect A00(Drawable drawable) {
        if (Build.VERSION.SDK_INT < 29 && A05) {
            try {
                ...
                if (invoke != null) {
                    return AbstractC23467Abq.A0I(A01.getInt(invoke), A03.getInt(invoke), A02.getInt(invoke), A00.getInt(invoke));
                }
            } catch (IllegalAccessException | InvocationTargetException unused) {
            }
        }
        return AbstractC07530Pc.A00;
    }
}
