...
public final class ADS implements InterfaceC43893JrU {
    public final C05V A00 = AbstractC34811ab.A0P();
    public final C219889og A01 = new C219889og(C00C.A02(AbstractC34881ai.A0b(AbstractC34821ac.A0K()), "com.whatsapp.psa.qp_surface"), "surfaceId");
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x00df A[ORIG_RETURN, RETURN] */
                                ...
                                switch (str3.hashCode()) {
                                    case -1806407742:
                                        if (str3.equals("SECONDS_SINCE_LESS_THAN")) {
                                            i2 = ((AbstractC34881ai.A06(this.A00) - this.A01.A04(enumC2042692s, str2)) > (parseLong * 1000) ? 1 : ((AbstractC34881ai.A06(this.A00) - this.A01.A04(enumC2042692s, str2)) == (parseLong * 1000) ? 0 : -1));
                                            return i2 > 0;
                                        }
                                        break;
                                    case -526668609:
                                        if (str3.equals("COUNT_AT_MOST")) {
                                            i2 = (this.A01.A03(enumC2042692s, str2) > parseLong ? 1 : (this.A01.A03(enumC2042692s, str2) == parseLong ? 0 : -1));
                                            if (i2 > 0) {
                                            }
                                        }
                                        break;
                                    case 851903629:
                                        if (str3.equals("COUNT_AT_LEAST")) {
                                            i = (this.A01.A03(enumC2042692s, str2) > parseLong ? 1 : (this.A01.A03(enumC2042692s, str2) == parseLong ? 0 : -1));
                                            return i < 0;
                                        }
                                        break;
                                    case 1832379851:
                                        if (str3.equals("SECONDS_SINCE_GREATER_THAN")) {
                                            i = ((AbstractC34881ai.A06(this.A00) - this.A01.A04(enumC2042692s, str2)) > (parseLong * 1000) ? 1 : ((AbstractC34881ai.A06(this.A00) - this.A01.A04(enumC2042692s, str2)) == (parseLong * 1000) ? 0 : -1));
                                            if (i < 0) {
                                            }
                                        }
                                        break;
