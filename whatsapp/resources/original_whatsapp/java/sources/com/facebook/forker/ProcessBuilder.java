...
public final class ProcessBuilder implements Cloneable {
    ...
    public ProcessBuilder setenv(String str, String str2) {
        if (str.indexOf(0) != -1 || str2.indexOf(0) != -1) {
            throw AbstractC34801aa.A0y("environment variables cannot contain NUL");
        }
        if (str.indexOf(61) != -1) {
            throw AbstractC34801aa.A0y("environment variable names cannot contain '='");
        }
        unsetenv(str);
    ...
    public static File genDefaultTmpDir(Context context) {
        return AbstractC37334GkA.A01(context, SC.android_fbapps_forker_tempdir);
    }
    ...
    public ProcessBuilder clearenv() {
        ArrayList arrayList = this.mEnvironKeys;
        if (arrayList == null) {
            this.mEnvironKeys = AbstractC34801aa.A16();
            this.mEnvironValues = AbstractC34801aa.A16();
            return this;
        }
        arrayList.clear();
    ...
    public Process create() {
        ...
        return new Process(str, AbstractC34881ai.A1b(arrayList, arrayList.size()), makeEnvironBlock(), getArrayOfSetBits(this.mKeepFds), this.mStreamDispositions, this.mTmpDir);
    }
    ...
    public void freezeEnviron() {
        if (this.mEnvironKeys == null) {
            ...
            while (A15.hasNext()) {
                ...
                A17.add(A18.getKey());
                A172.add(A18.getValue());
            }
            this.mEnvironKeys = A17;
            this.mEnvironValues = A172;
        }
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mArgv.size(); i++) {
            ...
            printWriter.print(AbstractC23467Abq.A11(this.mArgv, i));
        }
        Object[] A1Z = AbstractC34801aa.A1Z();
        A1Z[0] = Arrays.toString(getArrayOfSetBits(this.mKeepFds));
        A1Z[1] = Arrays.toString(this.mStreamDispositions);
        printWriter.format("] keepFds=[%s] streamDispositions=[%s]", A1Z);
        printWriter.print(">");
    ...
    public static byte[] buildEnvironBlock(ArrayList arrayList, ArrayList arrayList2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            i += AbstractC23467Abq.A11(arrayList, i2).length() + 1 + AbstractC23467Abq.A11(arrayList2, i2).length() + 1;
        }
        try {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                bufferedWriter.write(AbstractC23467Abq.A11(arrayList, i3));
                bufferedWriter.write(61);
                bufferedWriter.write(AbstractC23467Abq.A11(arrayList2, i3));
    ...
    public ProcessBuilder addArguments(Iterable iterable) {
        ...
        while (it.hasNext()) {
            addArgument(AbstractC34861ag.A11(it));
        }
        return this;
    }

    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public ProcessBuilder m687clone() {
        makeEnvironBlock();
        try {
    ...
    public ProcessBuilder() {
        int indexOf;
        this.mArgv = AbstractC34801aa.A16();
        ...
        if (str != null && (indexOf = str.indexOf(44)) != -1) {
            try {
                ...
                Log.d("fb-ProcessBuilder", "cannot parse property workspace FD", e);
            }
        }
    }
