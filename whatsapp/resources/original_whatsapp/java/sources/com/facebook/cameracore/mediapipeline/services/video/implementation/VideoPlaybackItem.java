...
import p000X.C40506I4k;
import p000X.C40751IFm;
import p000X.C40986IQw;
import p000X.C87T;
import p000X.JIZ;

/* loaded from: classes8.dex */
public class VideoPlaybackItem implements MediaPlayer.OnErrorListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, SurfaceTexture.OnFrameAvailableListener {
    ...
    public final AtomicInteger mAvailableFrames = C87T.A19(0);
    public final AtomicBoolean mHasError = C87T.A18(false);
    ...
    public VideoFrame getVideoFrameIfAvailable() {
        ...
        C40751IFm c40751IFm = this.mTexture;
        int i2 = c40751IFm.A00;
        int i3 = c40751IFm.A01;
        float[] fArr = this.mSMatrix;
        C40506I4k c40506I4k = c40751IFm.A02;
        int i4 = c40506I4k.A01;
        int i5 = c40506I4k.A00;
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        c40986IQw.A02 = 36197;
        c40986IQw.A03 = this.mMediaPlayer.getVideoWidth();
        c40986IQw.A01 = this.mMediaPlayer.getVideoHeight();
        C40751IFm c40751IFm = new C40751IFm(c40986IQw);
        this.mTexture = c40751IFm;
        SurfaceTexture surfaceTexture = new SurfaceTexture(c40751IFm.A00);
    ...
    public void prepare() {
        this.mBackgroundThread.execute(JIZ.A00(this, 48));
    }
    ...
    public void teardown() {
        ...
        this.mBackgroundThread.execute(JIZ.A00(this, 49));
    }
