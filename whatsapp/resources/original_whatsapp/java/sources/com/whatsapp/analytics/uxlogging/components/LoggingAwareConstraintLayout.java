...
public class LoggingAwareConstraintLayout extends ConstraintLayout implements InterfaceC36912GcV {
    public InterfaceC36694GWd A00;
    public boolean A01;
    public final C05V A02;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LoggingAwareConstraintLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    public LoggingAwareConstraintLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
        C00C.A0A(context, 0);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public LoggingAwareConstraintLayout(Context context) {
        this(context, null, 0);
        C00C.A0A(context, 0);
    }

    public /* synthetic */ LoggingAwareConstraintLayout(Context context, AttributeSet attributeSet, int i, int i2, C2X0 c2x0) {
