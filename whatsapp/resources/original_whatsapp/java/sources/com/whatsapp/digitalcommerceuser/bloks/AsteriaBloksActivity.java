...
public final class AsteriaBloksActivity extends BloksCDSBottomSheetActivity implements InterfaceC36750GZh {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AbstractC23470Abt.A1N("com\\.bloks\\.www\\.bloks\\.nme\\.gai(\\..+)*", patternArr);
        patternArr[1] = Pattern.compile("com\\.bloks\\.www\\.wa\\.bloks\\.nme\\.gai(\\..+)*");
        this.A01.A01 = C3WD.A1A(Pattern.compile("com\\.bloks\\.www\\.wa\\.nme\\.gai(\\..+)*"), patternArr, 2);
    }
