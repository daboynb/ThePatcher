...
public final class NotifySeamlessLinkingCompleteOperation extends LinkedOperation {
    public static final C39639HnC Companion = new C39639HnC();
    public final int version;

    public static final /* synthetic */ void write$Self$java_com_whatsapp_accountlinking_ipc_api_api(NotifySeamlessLinkingCompleteOperation notifySeamlessLinkingCompleteOperation, InterfaceC44153JwX interfaceC44153JwX, InterfaceC44143JwL interfaceC44143JwL) {
        if (interfaceC44153JwX.C5H() || notifySeamlessLinkingCompleteOperation.version != 1) {
            interfaceC44153JwX.AKt(interfaceC44143JwL, 0, notifySeamlessLinkingCompleteOperation.version);
        }
    }
    ...
    public /* synthetic */ NotifySeamlessLinkingCompleteOperation(int i, int i2, AbstractC39213Hfy abstractC39213Hfy) {
        if ((i & 1) == 0) {
            this.version = 1;
        } else {
            this.version = i2;
    ...
    public String toString() {
        ...
        A04.append("NotifySeamlessLinkingCompleteOperation(version=");
    ...
    public /* synthetic */ NotifySeamlessLinkingCompleteOperation(int i, int i2, C2X0 c2x0) {
        this((i2 & 1) != 0 ? 1 : i);
    }
