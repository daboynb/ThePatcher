...
public final class EngineErrno implements C15H {
    ...
    public static final EngineErrno f167x9e0bc0e;
    ...
    public static final EngineErrno f168x471d2742;

    /* renamed from: ENGINE_ERR_OUTGOING_CALL_REQUEST_ERROR_MICROPHONE_PERMISSION_REQUESTED */
    public static final EngineErrno f169x688e7a47;
    ...
    public static final EngineErrno f170x55989f4e;
    ...
    public static final C9A3 internalValueMap;
    public final int value;

    /* JADX WARN: Type inference failed for: r0v38, types: [X.9A3] */
    static {
        ...
        AbstractC34861ag.A1Y(engineErrno, engineErrno2, engineErrno3, engineErrno4, engineErrnoArr);
        AbstractC34921am.A14(engineErrno5, engineErrno6, engineErrno7, engineErrno8, engineErrnoArr);
        AbstractC34921am.A15(engineErrno9, engineErrno10, engineErrno11, engineErrno12, engineErrnoArr);
        AbstractC34921am.A16(engineErrno13, engineErrno14, engineErrno15, engineErrno16, engineErrnoArr);
        engineErrnoArr[16] = engineErrno17;
        C3WJ.A0u(engineErrno18, engineErrno19, engineErrno20, engineErrno21, engineErrnoArr);
        C3WI.A1J(engineErrno22, engineErrno23, engineErrno24, engineErrnoArr);
        engineErrnoArr[24] = engineErrno25;
        engineErrnoArr[25] = engineErrno26;
        engineErrnoArr[26] = engineErrno27;
        engineErrnoArr[27] = engineErrno28;
        $VALUES = engineErrnoArr;
        internalValueMap = new Object() { // from class: X.9A3
        };
    }
    ...
    public static EngineErrno forNumber(int i) {
        ...
        switch (i) {
            case 102:
                return f168x471d2742;
            case 103:
                return f169x688e7a47;
            case 104:
