...
.method public final Efm()V
    ...
    iget-object v0, p0, LX/IGQ;->A00:LX/ClY;

    const/4 v3, 0x2

    iget-object v2, v0, LX/ClY;->A05:LX/ClU;
...
.method public final GOU(LX/I8m;I)V
    ...
    invoke-virtual {p1, v0, v3, p2}, LX/I8m;->A00(Ljava/lang/String;FI)F
    ...
    iget-object v3, p0, LX/IGQ;->A00:LX/ClY;
    ...
    invoke-virtual/range {v3 .. v8}, LX/ClY;->A02(IFFFF)V
...
.method public final GQn(LX/I8m;Ljava/util/Map;I)V
    ...
    instance-of v0, v4, LX/IYO;

    if-eqz v0, :cond_0

    check-cast v4, LX/IYO;

    iget-object v2, v4, LX/IYO;->A04:LX/HVp;

    iget v1, v4, LX/IYO;->A03:F

    const-string v0, "scale"

    invoke-virtual {p1, v2, v0, v1, v3}, LX/I8m;->A01(LX/HVp;Ljava/lang/String;FI)V

    iget v1, v4, LX/IYO;->A02:F

    const-string v0, "rotation"

    invoke-virtual {p1, v2, v0, v1, v3}, LX/I8m;->A01(LX/HVp;Ljava/lang/String;FI)V

    iget v1, v4, LX/IYO;->A00:F

    const-string v0, "position_x"

    invoke-virtual {p1, v2, v0, v1, v3}, LX/I8m;->A01(LX/HVp;Ljava/lang/String;FI)V

    iget v1, v4, LX/IYO;->A01:F
