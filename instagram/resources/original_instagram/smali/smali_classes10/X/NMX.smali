...
# direct methods
.method public static final A00(LX/C46;)Landroid/os/Bundle;
    .locals 5
...
.method public static final A01(LX/1PD;LX/8z5;)Ljava/lang/Boolean;
    .locals 11
    ...
    invoke-direct {v10, p0, v1, v2, v5}, LX/Oe1;-><init>(LX/1PD;LX/1Ea;LX/1Ea;I)V

    invoke-static {v0}, LX/NMX;->A00(LX/C46;)Landroid/os/Bundle;
    ...
    invoke-direct {p1, p0}, Landroid/os/Bundle;-><init>(I)V

    if-eqz v0, :cond_0

    const/16 v6, 0x26

    invoke-virtual {v0, v6}, LX/C46;->A0A(I)LX/C46;
    ...
    invoke-virtual {v2, v6}, LX/C46;->A0O(I)Ljava/lang/String;
    ...
    sput-object p1, LX/DOF;->A01:LX/L2d;
    ...
    invoke-static {v2, v0, p0}, LX/1ms;->A0a(Ljava/lang/CharSequence;[Ljava/lang/String;I)Ljava/util/List;
