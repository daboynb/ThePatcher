...
.method public static final preloadClasses()V
    ...
    const-class v0, Lcom/instagram/direct/store/ReplaceDirectMessageLoader$replaceMessageByGraphQL$2$2;
    ...
    const-class v0, LX/9d3;

    const-class v0, LX/9e8;
    ...
    const-class v0, Landroidx/compose/foundation/gestures/ScrollableKt;
    ...
    const-class v0, LX/9o4;

    const-class v0, LX/9o7;

    const-class v0, LX/9o8;
    ...
    const-class v0, Landroidx/compose/ui/input/pointer/SuspendingPointerInputModifierNodeImpl$PointerEventHandlerCoroutine;
    ...
    const-class v0, Landroidx/compose/ui/unit/Constraints;
    ...
    const-class v0, Landroidx/compose/ui/graphics/layer/GraphicsLayer;
    ...
    const-class v0, Landroidx/compose/ui/platform/WrappedComposition;

    const-class v0, LX/2RF;

    const-class v0, Landroidx/compose/runtime/CompositionImpl;

    const-class v0, LX/0Cl;

    const-class v0, Landroidx/compose/runtime/SlotTable;
    ...
    const-class v0, Landroidx/compose/runtime/ComposerImpl;

    const-class v0, LX/2RN;

    const-class v0, LX/2RY;

    const-class v0, Landroidx/compose/runtime/SlotReader;
    ...
    const-class v0, Landroidx/compose/runtime/LaunchedEffectImpl;
    ...
    const-class v0, Landroidx/compose/ui/platform/AndroidCompositionLocals_androidKt;
    ...
    const-class v0, Landroidx/compose/runtime/external/kotlinx/collections/immutable/internal/MutabilityOwnership;

    const-class v0, Landroidx/compose/runtime/external/kotlinx/collections/immutable/internal/DeltaCounter;
    ...
    const-class v0, LX/9r9;

    const-class v0, LX/9s8;

    const-class v0, LX/9tS;
    ...
    const-class v0, Lcom/instagram/common/notifications/model/NotificationGenerationSource;
    ...
    const-class v0, LX/A2U;

    const-class v0, LX/A35;

    const-class v0, LX/A37;

    const-class v0, LX/A38;

    const-class v0, LX/A39;

    const-class v0, LX/A3B;
