...
.method public final GXN(Ljava/lang/Class;)Z
    ...
    iget-object v4, p0, LX/MiX;->A00:[LX/Opa;
    ...
    invoke-interface {v0, p1}, LX/Opa;->GXN(Ljava/lang/Class;)Z
...
.method public final GXb(Ljava/lang/Class;)LX/OkD;
    ...
    invoke-interface {v1, p1}, LX/Opa;->GXN(Ljava/lang/Class;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {v1, p1}, LX/Opa;->GXb(Ljava/lang/Class;)LX/OkD;
