...
.method public preloadClasses()V
    ...
    const-class v0, LX/Aar;

    const-class v0, LX/Aay;

    const-class v0, LX/Ab5;
    ...
    const-class v0, LX/AbX;

    const-class v0, LX/AbY;

    const-class v0, LX/Abj;
    ...
    const-class v0, LX/Ac2;

    const-class v0, LX/AcJ;
    ...
    const-class v0, LX/Af2;

    const-class v0, LX/Afi;
    ...
    const-class v0, LX/Agw;

    const-class v0, LX/Agx;

    const-class v0, LX/15S;

    const-class v0, LX/Agy;

    const-class v0, LX/Agz;

    const-class v0, LX/Ah2;

    const-class v0, LX/Ahi;

    const-class v0, LX/Ahq;
    ...
    const-class v0, LX/Ahy;

    const-class v0, LX/Ahz;

    const-class v0, LX/Ai2;

    const-class v0, LX/Aii;
    ...
    const-class v0, LX/80m;

    const-class v0, LX/80x;

    const-class v0, LX/80y;

    const-class v0, LX/81a;
    ...
    const-class v0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performInTransactionSuspending$2;
    ...
    const-class v0, Landroidx/room/util/DBUtil__DBUtil_androidKt$performInTransactionSuspending$2$invokeSuspend$$inlined$internalPerform$1;
    ...
    const-class v0, LX/84b;

    const-class v0, LX/Bz2;

    const-class v0, LX/84c;

    const-class v0, LX/9YZ;

    const-class v0, LX/Bzi;

    const-class v0, LX/84d;
    ...
    const-class v0, LX/Cz2;

    const-class v0, LX/CzL;

    const-class v0, LX/Czi;

    const-class v0, LX/Czq;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/storage/viewmodel/LowDeviceStorageViewModel$checkStorageSize$1;
    ...
    const-class v0, Lorg/pytorch/NativePeer;
    ...
    const-class v0, LX/FBO;

    const-class v0, LX/FBP;
    ...
    const-class v0, LX/FNn;

    const-class v0, LX/FNo;

    const-class v0, LX/FON;
    ...
    const-class v0, Lcom/instagram/model/filterkit/TextureAsset;
    ...
    const-class v0, Lorg/pytorch/PyTorchAndroid;
    ...
    const-class v0, Lorg/pytorch/LiteNativePeer;
    ...
    const-class v0, Lcom/google/android/material/floatingactionbutton/FloatingActionButton$BaseBehavior;

    const-class v0, Lcom/google/android/material/floatingactionbutton/ExtendedFloatingActionButton$ExtendedFloatingActionButtonBehavior;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/sundial/store/ClipsVideoStore$combinedVideoSegmentFlow$6;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/sundial/store/ClipsVirtualVideoStore$stitchedVideoWithPreviewAudioOverlayTrackFlow$4;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/sundial/viewmodel/ClipsCreationViewModel$5;
    ...
    const-class v0, Lcom/instagram/creation/capture/quickcapture/gallery/gallerygrid/viewmodel/GalleryMemoriesViewModel;

    const-class v0, LX/2J7;

    const-class v0, Lcom/instagram/moments/data/StandaloneMomentsDataSource;
    ...
    const-class v0, Lcom/instagram/quicksnap/data/repository/QuickSnapRepository$consumptionPreviewFlow$1;
    ...
    const-class v0, Lcom/instagram/igds/icons/PrismSwappingDrawable;
    ...
    const-class v0, Lcom/facebook/fbui/drawable/custom/AppRedrawableDrawable;
