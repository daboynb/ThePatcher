...
# direct methods
.method public static final A00(Landroid/content/Context;Ljava/util/Set;)LX/6AR;
    .locals 12
    ...
    sget-object v3, LX/6AU;->A00:Ljava/util/List;
    ...
    invoke-direct {v1, v0}, LX/3CA;-><init>(Ljava/util/Map;)V

    :try_start_0
    iget-object v0, v6, LX/KTl;->A00:Landroid/net/Uri;

    invoke-virtual {v1, p0, v0}, LX/3CA;->A01(Landroid/content/Context;Landroid/net/Uri;)Landroid/content/ContentProviderClient;
    ...
    :try_start_1
    invoke-static {v1}, LX/6Ad;->A00(Landroid/content/ContentProviderClient;)LX/6AR;
