...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, slice, i, nativeAllocateByteBuffer.slice(), i4, C33.A0q(nativeAllocateByteBuffer, i7, i6), i4, new Runnable() { // from class: org.webrtc.JavaI420Buffer$$ExternalSyntheticLambda1
    ...
    public static void checkCapacity(ByteBuffer byteBuffer, int i, int i2, int i3) {
        ...
        AbstractC27914AsI.A0I("Buffer must be at least ", A0X);
        A0X.append(i4);
        AbstractC27914AsI.A0I(" bytes, but was ", A0X);
        A0X.append(byteBuffer.capacity());
    ...
    public static JavaI420Buffer wrap(int i, int i2, ByteBuffer byteBuffer, int i3, ByteBuffer byteBuffer2, int i4, ByteBuffer byteBuffer3, int i5, Runnable runnable) {
        if (byteBuffer == null || byteBuffer2 == null || byteBuffer3 == null) {
            throw AnonymousClass031.A0R("Data buffers cannot be null.");
        }
        if (!byteBuffer.isDirect() || !byteBuffer2.isDirect() || !byteBuffer3.isDirect()) {
            throw AnonymousClass031.A0R("Data buffers must be direct byte buffers.");
        }
