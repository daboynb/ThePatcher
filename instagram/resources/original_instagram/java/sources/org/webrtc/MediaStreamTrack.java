...
public class MediaStreamTrack {
    ...
    public enum MediaType {
        ...
        public static MediaType fromNativeIndex(int i) {
            ...
            throw AnonymousClass216.A0x("Unknown native media type: ", AnonymousClass011.A0X(), i);
        }
    ...
    public MediaStreamTrack(long j) {
        if (j == 0) {
            throw AnonymousClass031.A0R("nativeTrack may not be null");
        }
        this.nativeTrack = j;
    }
    ...
    private void checkMediaStreamTrackExists() {
        if (this.nativeTrack == 0) {
            throw AnonymousClass011.A0J("MediaStreamTrack has been disposed.");
        }
    }
