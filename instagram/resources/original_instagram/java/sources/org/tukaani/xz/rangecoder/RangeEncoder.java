...
import p000X.AbstractC81638XPh;
import p000X.C8I;

/* loaded from: classes18.dex */
public final class RangeEncoder extends AbstractC81638XPh {
    ...
    public static int A00(short[] sArr, int i) {
        ...
        do {
            int i3 = length & 1;
            length >>>= 1;
            i2 = C8I.A04(A06, sArr[length], (-i3) & 2047, i2);
        } while (length != 1);
        return i2;
    }
    ...
    public static void A01(RangeEncoder rangeEncoder) {
        ...
        if (i != 0 || j < 4278190080L) {
            ...
            while (true) {
                ...
                int i2 = rangeEncoder.A01;
                rangeEncoder.A01 = i2 + 1;
                bArr[i2] = (byte) (b + i);
                int i3 = rangeEncoder.A02 - 1;
                rangeEncoder.A02 = i3;
                if (i3 == 0) {
                    break;
                } else {
