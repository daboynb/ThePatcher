...
public final class C07450Er implements Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        List<InterfaceC08830Jz> list = AbstractC07430Ep.A00;
        boolean z = false;
        if (!list.isEmpty()) {
            for (InterfaceC08830Jz interfaceC08830Jz : list) {
                if (interfaceC08830Jz.Elg(message) && !z) {
                    interfaceC08830Jz.A84(message, this);
                    z = true;
                }
            }
            if (z) {
    ...
    public C07450Er(Handler handler) {
        this.A01 = handler;
        Runnable runnable = new Runnable() { // from class: X.0Et
            ...
            public final void run() {
                /*
                    r5 = this;
                    r4 = 1
                    java.lang.reflect.Field r3 = p000X.C07450Er.A03     // Catch: java.lang.Throwable -> L34 java.lang.Throwable -> L4c
                    if (r3 != 0) goto L15
                    X.0Er r1 = p000X.C07450Er.this
                ...
                L12:
                    ...
                    throw r3
                L15:
                    X.0Er r2 = p000X.C07450Er.this     // Catch: java.lang.Throwable -> L34 java.lang.Throwable -> L34 java.lang.Throwable -> L4c
                ...
                L34:
                    ...
                    p000X.C08A.A0F(r1, r0, r2)     // Catch: java.lang.Throwable -> L4c
                    X.0Er r1 = p000X.C07450Er.this
                    java.util.concurrent.atomic.AtomicBoolean r0 = r1.A02
                    r0.set(r4)
                    monitor-enter(r1)
                ...
                L5c:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: p000X.RunnableC07470Et.run():void");
            }
        };
