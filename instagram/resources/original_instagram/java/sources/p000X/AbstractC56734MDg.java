...
public abstract class AbstractC56734MDg {
    ...
    public static void A01(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            ...
            throw AnonymousClass210.A0m(K3M.A00(str, A1a));
        }
    }
    ...
    public static void A02(int i, int i2, int i3) {
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                A00 = (i2 < 0 || i2 > i3) ? A00("end index", i2, i3) : K3M.A00("end index (%s) must not be less than start index (%s)", AnonymousClass216.A1a(i2, i));
