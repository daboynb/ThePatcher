...
public final class C2PR {
    ...
    public C2PR(float f, int i, int i2, int i3, int i4, boolean z) {
        ...
        this.A02 = i;
        this.A01 = i2;
        this.A03 = new float[i2 - 1];
        this.A04 = new float[i - 1];
    }
    ...
    public final void A02(Canvas canvas) {
        if (this.A00 > 0.0f) {
            ...
            for (float f3 : this.A03) {
                ...
                A00(canvas, paint, this.A04, f3 + 1.0f, rect3.left, rect3.right, f7);
            }
            for (float f8 : this.A04) {
                ...
                A01(canvas, paint2, this.A03, f8 + 1.0f, rect4.top, rect4.bottom, f9, 1);
            }
        }
    }
