...
public final class C37152Ed2 extends Drawable {
    public Bitmap A00;
    ...
    public C37152Ed2(Resources resources) {
        ...
        int dimensionPixelSize2 = resources.getDimensionPixelSize(2131165229);
        int dimensionPixelSize3 = resources.getDimensionPixelSize(2131165257);
        this.A04 = dimensionPixelSize3;
        int dimensionPixelSize4 = resources.getDimensionPixelSize(2131165190);
        this.A02 = dimensionPixelSize4;
        int dimensionPixelSize5 = resources.getDimensionPixelSize(2131165195);
        ...
        this.A03 = i;
        this.A0G = new RadialGradient((dimensionPixelSize / 2) + dimensionPixelSize3 + dimensionPixelSize4, i - f3, f5, 1291845632, 0, Shader.TileMode.CLAMP);
        ...
        paint.setColor(-1);
        paint3.setShadowLayer(dimensionPixelSize5, 0.0f, 0.0f, 1291845632);
        Path path = this.A08;
        path.reset();
