...
public final class C44527HXh extends C1A9 implements InterfaceC50596Jok, InterfaceC47146Ia8, InterfaceC50538Jno {
    public C96893m1 A00;
    public C97593n9 A01;
    public String A02;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C44527HXh) {
                C44527HXh c44527HXh = (C44527HXh) obj;
                if (!D1F.areEqual(this.A02, c44527HXh.A02) || !D1F.areEqual(this.A01, c44527HXh.A01) || !D1F.areEqual(this.A00, c44527HXh.A00)) {
                }
            }
            return false;
        }
    ...
    public final String toString() {
        ...
        AbstractC27914AsI.A0I("NotesXmaMessageViewModel(id=", A0X);
