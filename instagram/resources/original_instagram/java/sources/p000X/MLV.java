...
public abstract class MLV {
    public static String A00(String str, int i, int i2) {
        ...
        return AbstractC54259LGb.A01(str2, A1b);
    }
    ...
    public static void A01(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            ...
            throw AnonymousClass210.A0m(AbstractC54259LGb.A01(str, A1a));
        }
    }
    ...
    public static void A03(int i, int i2, int i3) {
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                A00 = (i2 < 0 || i2 > i3) ? A00("end index", i2, i3) : AbstractC54259LGb.A01("end index (%s) must not be less than start index (%s)", AnonymousClass216.A1a(i2, i));
    ...
    public static void A04(Object obj, Object obj2) {
        if (obj == null) {
            throw AnonymousClass210.A0p((String) obj2);
        }
    }
}
