...
public final class C34870DhG extends APQ implements InterfaceC63073OkW {
    public static final C34870DhG DEFAULT_INSTANCE;
    ...
    static {
        C34870DhG c34870DhG = new C34870DhG();
        DEFAULT_INSTANCE = c34870DhG;
        APQ.A08(c34870DhG, C34870DhG.class);
    }
    ...
    public final Object A0D(Integer num) {
        ...
        switch (num.intValue()) {
            ...
            case 3:
                return new C34870DhG();
            case 4:
                return new C34610Dd4();
            case 5:
