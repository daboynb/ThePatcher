...
public abstract class AbstractC29847BiN extends AnonymousClass251 {
    public static ImmutableList A00(C42R c42r) {
        ImmutableList CIV = c42r.CIV(1327492419);
        if (CIV == null) {
            return null;
        }
        ...
        while (it.hasNext()) {
            A0c.add(new C29700Bg0(null, AnonymousClass011.A07(it)));
        }
