...
public abstract class CQB extends Drawable {
    public float A00;
    public int A01;
    public int A02;
    public int A04;
    ...
    public int A03 = 119;
    public final Paint A08 = AnonymousClass327.A0M(3);
    public final Matrix A0B = AnonymousClass327.A0K();
    public final Rect A09 = AnonymousClass327.A0O();
    public final RectF A0C = AnonymousClass327.A0Q();
    public boolean A05 = true;

    public CQB(Resources resources, Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            bitmapShader = AnonymousClass327.A0I(bitmap);
        } else {
            this.A01 = -1;
            this.A02 = -1;
            bitmapShader = null;
    ...
    public final void A01() {
        ...
        if (this.A05) {
            ...
            if (bitmapShader != null) {
                ...
                matrix.preScale(width / AnonymousClass327.A03(bitmap), rectF.height() / AnonymousClass327.A02(bitmap));
    ...
    public final void A02(float f) {
        if (this.A00 != f) {
            this.A06 = false;
            this.A08.setShader(AnonymousClass021.A1S((f > 0.05f ? 1 : (f == 0.05f ? 0 : -1))) ? this.A0A : null);
            this.A00 = f;
            invalidateSelf();
        }
    }
    ...
    public final int getOpacity() {
        Bitmap bitmap;
        return (this.A03 != 119 || this.A06 || (bitmap = this.A07) == null || bitmap.hasAlpha() || this.A08.getAlpha() < 255 || this.A00 > 0.05f) ? -3 : -1;
    }
