...
public final class C98493ob extends AbstractC49249JJj {
    @Override // p000X.AbstractC49249JJj
            ...
            while (i < i2) {
                ...
                if (i5 < 0) {
                    if (i5 >= -32) {
                        ...
                        AbstractC49249JJj abstractC49249JJj = AbstractC98223oA.A00;
                        int i10 = bArr[i4 - 1];
                        int i11 = i2 - i4;
                        if (i11 == 0) {
                            if (i10 > -12) {
    ...
    @Override // p000X.AbstractC49249JJj
    public final String A02(byte[] bArr, int i, int i2) {
            ...
            if (b2 < 0) {
                if (b2 >= -32) {
                    if (b2 >= -16) {
                        ...
                        int i8 = i7 + 1;
                        i = i8 + 1;
                        AbstractC56712MCk.A00(cArr, b2, bArr[i6], bArr[i7], bArr[i8], i4);
                        i4 = i4 + 1 + 1;
                    } else {
                        if (i6 >= i3 - 1) {
                            break;
                        ...
                        i = i9 + 1;
                        i4++;
                        AbstractC56712MCk.A01(cArr, b2, bArr[i6], bArr[i9], i5);
                    }
                } else {
                    if (i6 >= i3) {
                        break;
                    ...
                    i = i6 + 1;
                    i4++;
                    AbstractC56712MCk.A02(cArr, b2, bArr[i6], i5);
                }
            } else {
                i4++;
                cArr[i5] = (char) b2;
    ...
    public final int A00(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i8 < length) {
            ...
            if ((charAt2 >= 55296 && 57343 >= charAt2) || i9 > i7 - 3) {
                ...
                throw new C48290Isa(i8 - 1, length);
            }
            int i11 = i9 + 1;
