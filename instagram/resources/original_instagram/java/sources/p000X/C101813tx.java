...
public final class C101813tx {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof C101813tx) {
            C101813tx c101813tx = (C101813tx) obj;
            int i = this.A00;
            if (i == c101813tx.A00) {
                int i2 = i * 2;
                int i3 = 0;
                while (true) {
                    if (i3 >= i2) {
                        for (int i4 = 0; i4 < i; i4++) {
                            if (this.A01[i4] == c101813tx.A01[i4]) {
                            }
                        }
                        return true;
                    }
                    String str = this.A02[i3];
                    String str2 = c101813tx.A02[i3];
                    if (str == null) {
                        if (str2 != null) {
                            break;
                        }
    ...
    public final String toString() {
        ...
        for (int i2 = 0; i2 < this.A00; i2++) {
            sb.append('\"');
            AbstractC27914AsI.A0I(this.A02[i], sb);
            AbstractC27914AsI.A0I("\":\"", sb);
            AbstractC27914AsI.A0I(this.A02[i + 1], sb);
            AbstractC27914AsI.A0I("\",", sb);
            i += 2;
        }
