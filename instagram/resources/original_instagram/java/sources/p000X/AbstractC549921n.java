...
public abstract class AbstractC549921n {
    public static final ThreadLocal A02 = new ThreadLocal() { // from class: X.21r
        @Override // java.lang.ThreadLocal
        public final /* bridge */ /* synthetic */ Object initialValue() {
            return new PathMeasure();
        }
    };
    public static final ThreadLocal A03 = new ThreadLocal() { // from class: X.21s
        @Override // java.lang.ThreadLocal
        public final /* bridge */ /* synthetic */ Object initialValue() {
            return new Path();
        }
    };
    public static final ThreadLocal A04 = new ThreadLocal() { // from class: X.21t
        @Override // java.lang.ThreadLocal
        public final /* bridge */ /* synthetic */ Object initialValue() {
            return new Path();
        }
    };
    public static final ThreadLocal A00 = new ThreadLocal() { // from class: X.21u
        @Override // java.lang.ThreadLocal
        public final /* bridge */ /* synthetic */ Object initialValue() {
            return new float[4];
        }
    ...
    public static Bitmap A02(Bitmap bitmap, int i, int i2) {
        ...
        Bitmap A002 = AbstractC187857Mn.A00(bitmap, i, i2, true);
        bitmap.recycle();
        return A002;
    }
    ...
    public static void A03(Path path, float f, float f2, float f3) {
        ...
        if (!(f == 1.0f && f2 == 0.0f) && length >= 1.0f && Math.abs((f2 - f) - 1.0f) >= 0.01d) {
            ...
            if (min >= length && max >= length) {
                min = AbstractC553222u.A00(min, length);
                max = AbstractC553222u.A00(max, length);
            }
            if (min < 0.0f) {
                min = AbstractC553222u.A00(min, length);
            }
