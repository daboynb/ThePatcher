...
public final class C5PK implements InterfaceC06660Bq {
    public String A00;
    public String A01;
    public boolean A02;
    public boolean A03;
    ...
    public boolean A0C;
    public boolean A0D;
    public final InterfaceC50791Jrt A0E;
    public final Pattern A0F;
    public final Pattern A0G;
    public final boolean A0H;

    public C5PK(boolean z) {
        this.A0G = Pattern.compile("(\\d+\\.\\d+)\\s([KkMmGg]B|bytes)");
        this.A0F = Pattern.compile("numLayers\\s+=\\s+(\\d+)");
        this.A0E = new InterfaceC50791Jrt() { // from class: X.5PL
            @Override // p000X.InterfaceC50791Jrt
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (str.equals("CPU Caches:")) {
                            ...
                            while (readLine != null && readLine.startsWith(" ")) {
                                ...
                                if (matcher.find()) {
                                    if (this.A00.contains("Glyph Cache:")) {
                                        arrayList.add(new C06900Co(C06680Bs.A0D, A00(matcher)));
                                        this.A03 = true;
                                        z2 = true;
                                    } else {
                                        j += A00(matcher);
                            ...
                            if (j > 0 || this.A09) {
                                arrayList.add(new C06900Co(C06680Bs.A0E, j));
                                this.A09 = true;
                            }
                            if (this.A03 && !z2) {
                                arrayList.add(new C06900Co(C06680Bs.A0D, 0L));
                            }
                            ...
                            if (j2 > 0 || this.A0A) {
                                arrayList.add(new C06900Co(C06680Bs.A0M, j2));
                                this.A0A = true;
                            }
                            if (j3 > 0 || this.A05) {
                                arrayList.add(new C06900Co(C06680Bs.A0L, j3));
                                this.A05 = true;
                            }
                            if (j4 > 0 || this.A04) {
                                arrayList.add(new C06900Co(C06680Bs.A0K, j4));
                                this.A04 = true;
                            }
                            if (j5 > 0 || this.A0B) {
                                arrayList.add(new C06900Co(C06680Bs.A0N, j5));
                                this.A0B = true;
                            }
                            ...
                            if (j6 > 0 || this.A0C) {
                                arrayList.add(new C06900Co(C06680Bs.A0F, j6));
                                this.A0C = true;
                            }
                            if (j7 > 0 || this.A02) {
                                arrayList.add(new C06900Co(C06680Bs.A0G, j6));
                                this.A02 = true;
                            }
                            ...
                            if (j8 > 0 || this.A0D) {
                                arrayList.add(new C06900Co(C06680Bs.A0P, j8));
                                this.A0D = true;
                            }
                            if (j9 > 0 || this.A06) {
                                arrayList.add(new C06900Co(C06680Bs.A0O, j9));
                                this.A06 = true;
                            }
                            ...
                            if (j10 > 0 || this.A08) {
                                arrayList.add(new C06900Co(C06680Bs.A0Z, j10));
                                this.A08 = true;
                            }
                            if (i > 0 || this.A07) {
                                c06900Co = new C06900Co(C06680Bs.A0a, i);
                                arrayList.add(c06900Co);
                                this.A07 = z;
                            }
                            ...
                            if (j11 > 0 || this.A08) {
                                arrayList.add(new C06900Co(C06680Bs.A0Z, j11));
                                this.A08 = true;
                            }
                            if (i2 > 0 || this.A07) {
                                c06900Co = new C06900Co(C06680Bs.A0a, i2);
                                arrayList.add(c06900Co);
                                this.A07 = z;
                            }
                            ...
                            while (readLine7 != null && readLine7.startsWith(" ")) {
                                if (!z5) {
                                    ...
                                    if (matcher9.find()) {
                                        arrayList.add(new C06900Co(C06680Bs.A0D, A00(matcher9)));
                                        z5 = true;
                                    }
                                }
