...
public enum NKS {
    ...
    /* JADX INFO: Fake field, exist only in values array */
    MOMA_ADN_NEW_ELIGIBILITY_MISSING_FIELDS("MOMA_ADN_NEW_ELIGIBILITY_MISSING_FIELDS"),
    /* JADX INFO: Fake field, exist only in values array */
    MOMA_MISSING_FIELDS("MOMA_MISSING_FIELDS"),
    PAYOUT_HOLD("PAYOUT_HOLD"),
    /* JADX INFO: Fake field, exist only in values array */
    STABLE_COIN_WALLET_ONBOARDING("STABLE_COIN_WALLET_ONBOARDING"),
    TASKLESS_INTERVIEW_INCOMPLETE("TASKLESS_INTERVIEW_INCOMPLETE"),
    /* JADX INFO: Fake field, exist only in values array */
    TAX_ID_NOT_VALID("TAX_ID_NOT_VALID"),
    /* JADX INFO: Fake field, exist only in values array */
    UOP_MISSING_FIELDS("UOP_MISSING_FIELDS"),
    /* JADX INFO: Fake field, exist only in values array */
    W8_RENEWAL("W8_RENEWAL"),
    /* JADX INFO: Fake field, exist only in values array */
    XSELL("XSELL");
