...
public abstract class AbstractC43941io {
    public static void A00(ApplicationInfo applicationInfo, ClassLoader classLoader, List list, List list2) {
        String str;
        Object[] objArr;
        long currentTimeMillis = System.currentTimeMillis();
        if (!AbstractC43931in.A01) {
            throw new C45271kx("Cannot call needed hidden apis on this platform");
        }
        ...
        try {
            AbstractC43931in.A00.invoke(builder, new Object[0]);
        ...
        try {
            try {
                ...
                if (str2 == null) {
                    throw new C45271kx("Cannot find a primary dex name");
                }
                boolean exists = new File(str2).exists();
                if (objArr2 == null) {
                    throw new C45271kx("dexElements is null");
                }
                ...
                throw new C45271kx("Dalvik system code not of expected form", e);
            }
        } finally {
            if (vmPolicy != null) {
