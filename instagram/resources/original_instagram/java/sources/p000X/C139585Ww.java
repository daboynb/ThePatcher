...
public final class C139585Ww extends Drawable {
    public float A00;
    public float A01;
    ...
    public C139585Ww(ColorStateList colorStateList, float f) {
        this.A01 = f;
    ...
    public static void A00(Rect rect, C139585Ww c139585Ww) {
        if (rect == null) {
            rect = c139585Ww.getBounds();
        }
        RectF rectF = c139585Ww.A0A;
        rectF.set(rect.left, rect.top, rect.right, rect.bottom);
        Rect rect2 = c139585Ww.A09;
        rect2.set(rect);
        if (c139585Ww.A03) {
            float f = c139585Ww.A00;
            float f2 = c139585Ww.A01;
            boolean z = c139585Ww.A04;
            double d = AbstractC28741BDl.A00;
            float f3 = f * 1.5f;
            if (z) {
                double d2 = (1.0d - AbstractC28741BDl.A00) * f2;
                f3 = (float) (f3 + d2);
                f = (float) (f + d2);
            }
    ...
    public final boolean isStateful() {
        ...
        ColorStateList colorStateList2 = this.A02;
