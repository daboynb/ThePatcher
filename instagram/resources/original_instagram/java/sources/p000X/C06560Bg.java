...
public final class C06560Bg extends C0AU {
    public int A00;
    ...
    public static final void A04(C06560Bg c06560Bg, int i) {
        c06560Bg.A01--;
        long[] jArr = c06560Bg.A03;
        int i2 = ((C0AU) c06560Bg).A00;
        int i3 = i >> 3;
        int i4 = (i & 7) << 3;
    ...
    public final void A08() {
        ...
        while (i5 != i) {
            ...
            if (j2 != 128 && j2 == 254) {
                ...
                int A01 = A01(i7);
                int i8 = i7 & i;
                if (((A01 - i8) & i) / 8 == ((i5 - i8) & i) / 8) {
                    int i9 = i5 >> 3;
                    int i10 = (i5 & 7) << 3;
                    jArr[i9] = ((r3 & 127) << i10) | (jArr[i9] & ((255 << i10) ^ (-1)));
                } else {
                    int i11 = A01 >> 3;
                    long j3 = jArr[i11];
                    int i12 = (A01 & 7) << 3;
    ...
    public final void A09(C0AU c0au) {
        int[] iArr = c0au.A02;
        long[] jArr = c0au.A03;
    ...
    private final int A00(int i) {
        ...
        while (true) {
            ...
            if ((j & ((j ^ (-1)) << 6) & (-9187201950435737472L)) != 0) {
                int A01 = A01(i4);
                if (this.A00 == 0 && ((jArr[A01 >> 3] >> ((A01 & 7) << 3)) & 255) != 254) {
                    if (i6 > 8) {
                        if (((this.A01 * 32) ^ Long.MIN_VALUE) <= ((i6 * 25) ^ Long.MIN_VALUE)) {
                            A08();
                            A01 = A01(i4);
                        }
                    }
                    ...
                    for (int i13 = 0; i13 < i6; i13++) {
                        if (((jArr[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                            ...
                            int A012 = A01((i15 ^ (i15 << 16)) >>> 7);
                            int i16 = A012 >> 3;
                            int i17 = (A012 & 7) << 3;
                            long j5 = (jArr2[i16] & ((255 << i17) ^ (-1))) | ((r1 & 127) << i17);
                            jArr2[i16] = j5;
                            jArr2[(((A012 - 7) & i12) + (i12 & 7)) >> 3] = j5;
                            iArr2[A012] = i14;
                        }
                    }
                    A01 = A01(i4);
                ...
                long j6 = jArr3[i19];
                int i20 = (A01 & 7) << 3;
                this.A00 = i18 - (((j6 >> i20) & 255) == 128 ? 1 : 0);
                int i21 = super.A00;
                long j7 = (((255 << i20) ^ (-1)) & j6) | (j2 << i20);
                jArr3[i19] = j7;
                jArr3[(((A01 - 7) & i21) + (i21 & 7)) >> 3] = j7;
                return A01;
            }
            i8 += 8;
            i7 = (i7 + i8) & i6;
        ...
        while (true) {
            ...
            for (long j3 = (j2 ^ (-1)) & (j2 - 72340172838076673L) & (-9187201950435737472L); j3 != 0; j3 &= j3 - 1) {
                ...
                if (this.A02[numberOfTrailingZeros] == i) {
                    ...
                    A04(this, numberOfTrailingZeros);
                    return true;
                }
            }
            if ((j & ((j ^ (-1)) << 6) & (-9187201950435737472L)) != 0) {
