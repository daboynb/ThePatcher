...
public final class S7v extends Fragment implements InterfaceC83503YaA {
    ...
    public final void A9I(LifecycleCallback lifecycleCallback, String str) {
        ...
        if (this.A00 > 0) {
            new HandlerC240899Un(Looper.getMainLooper()).post(new RunnableC97264mqg(lifecycleCallback, this, str));
        }
    }
    ...
    @Override // p000X.InterfaceC83503YaA
    public final /* synthetic */ Activity C2D() {
        return getActivity();
    }
    ...
    public final void onCreate(Bundle bundle) {
        int A02 = AbstractC315719l.A02(-544826621);
        ...
        AbstractC315719l.A09(-958236405, A02);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onDestroy() {
        int A02 = AbstractC315719l.A02(1576057034);
        super.onDestroy();
        this.A00 = 5;
        Iterator A14 = AnonymousClass215.A14(this.A02);
        while (A14.hasNext()) {
        ...
        AbstractC315719l.A09(-1150198533, A02);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onResume() {
        int A02 = AbstractC315719l.A02(-1059664708);
        super.onResume();
        this.A00 = 3;
        Iterator A14 = AnonymousClass215.A14(this.A02);
        while (A14.hasNext()) {
        ...
        AbstractC315719l.A09(2018005250, A02);
    }
    ...
    public final void onStart() {
        int A02 = AbstractC315719l.A02(1474959548);
        super.onStart();
        this.A00 = 2;
        Iterator A14 = AnonymousClass215.A14(this.A02);
        while (A14.hasNext()) {
        ...
        AbstractC315719l.A09(1912662489, A02);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onStop() {
        int A02 = AbstractC315719l.A02(-949417288);
        super.onStop();
        this.A00 = 4;
        Iterator A14 = AnonymousClass215.A14(this.A02);
        while (A14.hasNext()) {
        ...
        AbstractC315719l.A09(2003769891, A02);
    }
}
