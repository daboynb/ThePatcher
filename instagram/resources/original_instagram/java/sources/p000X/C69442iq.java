...
public final class C69442iq {
    public static final C69442iq A04 = new C69442iq();
    public final Set A01 = new HashSet();
    public final Class[] A02 = new Class[137];
    public int A00 = 37;
    public final AtomicBoolean A03 = new AtomicBoolean(false);

    public final synchronized void A00(Class cls) {
        if (cls != null) {
            if (this.A00 < 137 && this.A01.add(cls)) {
    ...
    public final Class[] A01() {
        ...
        if (this.A03.compareAndSet(false, true)) {
            synchronized (this) {
                ...
                clsArr[33] = SurfaceTexture.class;
                clsArr[34] = Surface.class;
                clsArr[35] = SurfaceTexture.OnFrameAvailableListener.class;
                clsArr[36] = PhantomReference.class;
            }
        }
        return this.A02;
    }
