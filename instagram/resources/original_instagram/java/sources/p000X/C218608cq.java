...
public final class C218608cq {
    public final LightweightQuickPerformanceLogger A00;

    public static EventBuilder A00(C218608cq c218608cq, String str, String str2, long j) {
        EventBuilder markEventBuilder = c218608cq.A00.markEventBuilder(21370350, str);
    ...
    public C218608cq(LightweightQuickPerformanceLogger lightweightQuickPerformanceLogger) {
        this.A00 = lightweightQuickPerformanceLogger;
    }

    public static void A01(C218608cq c218608cq, CharSequence charSequence, String str, String str2, String str3, int i, int i2, int i3, long j) {
        EventBuilder A00 = A00(c218608cq, str2, str, System.currentTimeMillis());
