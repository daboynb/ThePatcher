...
public final class C232188yk implements InterfaceC98155oAH, Function1 {
    public final int $t;
    ...
    @NeverInline
    public C232188yk(String str, List list, int i, int i2, int i3, long j, long j2, boolean z) {
        this.$t = i3;
        this.A05 = str;
        this.A04 = list;
        this.A00 = i;
    ...
    public final Object invoke(Object obj) {
        ...
        try {
            ...
            int A003 = AbstractC119214gv.A00(FW2, "cached_time_s");
            int A004 = AbstractC119214gv.A00(FW2, "sort_key");
            int A005 = AbstractC119214gv.A00(FW2, "sort_score");
            int A006 = AbstractC119214gv.A00(FW2, "expiration_time_s");
            ...
            while (FW2.GJO()) {
                ...
                double d = FW2.getDouble(A005);
                long j4 = FW2.getLong(A006);
                int i4 = (int) FW2.getLong(A007);
                boolean z2 = false;
                if (((int) FW2.getLong(A008)) != 0) {
                    z2 = true;
                }
                arrayList.add(new C119364hA(CyE, CyE2, CyE3, FW2.getBlob(A009), d, i4, j3, j4, z2));
            }
            return arrayList;
        } finally {
            FW2.close();
