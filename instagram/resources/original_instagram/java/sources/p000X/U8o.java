...
public final class U8o extends C156035zD implements InterfaceC98238obv {
    ...
    public final void AkA(ByteBuffer byteBuffer, int i) {
        ...
        if (A07 == null) {
            throw AnonymousClass031.A0R("commands cannot be null");
        }
        float[] A08 = AbstractC94164eyQ.A08(byteBuffer, i, 1);
        if (A08 == null) {
            throw AnonymousClass031.A0R("points cannot be null");
        }
        int i9 = 0;
        int i10 = 0;
        while (true) {
