...
public abstract class AbstractC49235JIv {
    ...
    */
    public final int A00(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            while (i10 < length) {
                ...
                if ((charAt3 >= 55296 && 57343 >= charAt3) || i11 > i9 - 3) {
                    if (i11 > i9 - 4) {
                        ...
                        throw new C48326ItA(i10, length);
                    }
                    ...
                    throw new C48326ItA(i10 - 1, length);
                }
                int i13 = i11 + 1;
        ...
        if (i14 != length2) {
            while (i14 < length2) {
                ...
                if (j3 <= j4 - 2) {
                    j = j3 + 1;
                    MOK.A07(bArr, (byte) ((charAt6 >>> 6) | 960), j3);
                    j2 = j + 1;
                    i7 = (charAt6 & '?') | 128;
                    b = (byte) i7;
                    MOK.A07(bArr, b, j);
                ...
                if ((charAt6 >= 55296 && 57343 >= charAt6) || j3 > j4 - 3) {
                    if (j3 > j4 - 4) {
                        ...
                        throw new C48326ItA(i14, length2);
                    }
                    if (i14 + 1 != length2) {
                        i14++;
                        ...
                        if (Character.isSurrogatePair(charAt6, charAt7)) {
                            ...
                            long j5 = j3 + 1;
                            MOK.A07(bArr, (byte) ((codePoint2 >>> 18) | 240), j3);
                            long j6 = j5 + 1;
                            MOK.A07(bArr, (byte) (((codePoint2 >>> 12) & 63) | 128), j5);
                            j = j6 + 1;
                            MOK.A07(bArr, (byte) (((codePoint2 >>> 6) & 63) | 128), j6);
                            j2 = j + 1;
                    ...
                    throw new C48326ItA(i14 - 1, length2);
                }
                long j7 = j3 + 1;
                MOK.A07(bArr, (byte) ((charAt6 >>> '\f') | 480), j3);
                j = j7 + 1;
                MOK.A07(bArr, (byte) (((charAt6 >>> 6) & 63) | 128), j7);
                j2 = j + 1;
                i7 = (charAt6 & '?') | 128;
                b = (byte) i7;
                MOK.A07(bArr, b, j);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:56:0x019d, code lost:
        ...
        r1 = p000X.MOK.A01.A01(r19, p000X.MOK.A00 + r4);
        r0 = p000X.LSU.A00;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x0111, code lost:
        ...
        if (p000X.MOK.A01.A01(r19, p000X.MOK.A00 + r4) > (-65)) goto L149;
     */
    ...
    public final int A01(byte[] bArr, int i, int i2) {
        ...
        if (this instanceof C33850DEc) {
            ...
            if (i5 >= 16) {
                ...
                while (true) {
                    long j3 = j2 + 1;
                    if (MOK.A01.A01(bArr, MOK.A00 + j2) < 0) {
                        break;
                    }
                    i3++;
                    j2 = j3;
            ...
            while (true) {
                ...
                while (true) {
                    if (i6 > 0) {
                        long j5 = j4 + 1;
                        b3 = MOK.A01.A01(bArr, MOK.A00 + j4);
                        if (b3 < 0) {
                            j4 = j5;
                            break;
                        }
        ...
        while (i4 < i2) {
            ...
            if (b < 0) {
                if (b >= -32) {
                    ...
                    AbstractC49235JIv abstractC49235JIv = LSU.A00;
                    b3 = bArr[i7 - 1];
                    int i11 = i2 - i7;
                    if (i11 == 0) {
                        if (b3 > -12) {
