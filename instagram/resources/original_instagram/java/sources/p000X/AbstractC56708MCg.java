...
public abstract class AbstractC56708MCg {
    public Unsafe A00;

    public AbstractC56708MCg(Unsafe unsafe) {
        this.A00 = unsafe;
    }

    public static int A00(long j, Object obj) {
        return C57012MNy.A01.A00.getInt(obj, (-4) & j);
    }

    public byte A01(Object obj, long j) {
        boolean z = this instanceof C32898CqY;
        boolean z2 = C57012MNy.A06;
        int A00 = A00(j, obj);
    ...
    public void A06(Object obj, long j, byte b) {
        boolean z = C57012MNy.A06;
        long j2 = j & (-4);
        AbstractC56708MCg abstractC56708MCg = C57012MNy.A01;
        int A04 = abstractC56708MCg.A04(obj, j2);
        if (z) {
            abstractC56708MCg.A09(obj, j2, C21Q.A01(((int) j) ^ (-1), A04, b));
        } else {
            abstractC56708MCg.A09(obj, j2, C21Q.A01((int) j, A04, b));
        }
    }
