...
public abstract class AbstractC69772jN {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            if (value != null) {
                if (value instanceof String) {
                    ...
                    C28035AuF.A03("VideoQpl", String.format(Locale.US, "Failed to annotate marker: markerId %d instanceId %d key %s value %s class %s", Integer.valueOf(i), Integer.valueOf(i2), str, value, value.getClass().getSimpleName()));
                }
            }
        }
    }
