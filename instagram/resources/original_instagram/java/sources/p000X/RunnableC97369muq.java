...
public final class RunnableC97369muq implements Runnable {
    ...
    public RunnableC97369muq(MqttPublishExtListener mqttPublishExtListener, int i, int i2, int i3, int i4, int i5) {
