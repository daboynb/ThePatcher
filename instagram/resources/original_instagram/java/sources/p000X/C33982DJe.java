...
public final class C33982DJe<K, V> extends AbstractMapBasedMultimap<K, V>.SortedAsMap implements NavigableMap<K, Collection<V>> {
    public final /* synthetic */ AbstractMapBasedMultimap A00;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C33982DJe(final AbstractMapBasedMultimap this$0, NavigableMap submap) {
        super(this$0, submap);
        this.A00 = this$0;
    }
    ...
    public final ImmutableEntry A02(Iterator entryIterator) {
        ...
        Map.Entry A0g = AnonymousClass011.A0g(entryIterator);
        AbstractMapBasedMultimap abstractMapBasedMultimap = this.A00;
        Collection A0A = abstractMapBasedMultimap.A0A();
        A0A.addAll(AnonymousClass217.A10(A0g));
        entryIterator.remove();
        return new ImmutableEntry(A0g.getKey(), abstractMapBasedMultimap.A0D(A0A));
    }
    ...
    public final NavigableMap descendingMap() {
        return new C33982DJe(this.A00, ((NavigableMap) ((SortedMap) this.A00)).descendingMap());
    }
    ...
    public final NavigableMap headMap(Object toKey, boolean inclusive) {
        return new C33982DJe(this.A00, ((NavigableMap) ((SortedMap) this.A00)).headMap(toKey, inclusive));
    }
    ...
    public final Map.Entry pollFirstEntry() {
        return A02(AnonymousClass011.A0d(this));
    }
    ...
    public final NavigableMap subMap(Object fromKey, boolean fromInclusive, Object toKey, boolean toInclusive) {
        return new C33982DJe(this.A00, ((NavigableMap) ((SortedMap) this.A00)).subMap(fromKey, fromInclusive, toKey, toInclusive));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap tailMap(Object fromKey, boolean inclusive) {
        return new C33982DJe(this.A00, ((NavigableMap) ((SortedMap) this.A00)).tailMap(fromKey, inclusive));
    }
}
