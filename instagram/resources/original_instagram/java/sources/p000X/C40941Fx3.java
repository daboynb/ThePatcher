...
public final class C40941Fx3 extends BZ6 implements InterfaceC94222fAK {
    public C13F A00;
    public C32851Ej A01;
    public A6Z A02;
    public Integer A03;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C40941Fx3) {
                C40941Fx3 c40941Fx3 = (C40941Fx3) obj;
                if (!D1F.areEqual(this.A02, c40941Fx3.A02) || !D1F.areEqual(this.A03, c40941Fx3.A03) || !D1F.areEqual(this.A05, c40941Fx3.A05) || !D1F.areEqual(this.A00, c40941Fx3.A00) || !D1F.areEqual(this.A01, c40941Fx3.A01) || !D1F.areEqual(this.A06, c40941Fx3.A06) || !D1F.areEqual(this.A04, c40941Fx3.A04)) {
                }
            }
            return false;
        }
