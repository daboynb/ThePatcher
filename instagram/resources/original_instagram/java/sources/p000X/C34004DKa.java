...
public class C34004DKa<V> extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements List<V> {
    public final /* synthetic */ AbstractMapBasedMultimap A00;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C34004DKa(final AbstractC61187NvB this$0, AbstractMapBasedMultimap key, Object delegate, List ancestor) {
    ...
    public final List subList(int fromIndex, int toIndex) {
        ...
        return subList instanceof RandomAccess ? new DKY(abstractC61187NvB, abstractMapBasedMultimap, obj, subList) : new C34004DKa(abstractC61187NvB, abstractMapBasedMultimap, obj, subList);
    }
