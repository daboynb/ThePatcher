...
public final class C46519ICf extends FilterInputStream {
    public long A00;
    public long A01;

    public C46519ICf(InputStream in, long limit) {
        super(in);
        this.A01 = -1L;
        AbstractC47541oc.A0J(limit >= 0, "limit must be non-negative");
        this.A00 = limit;
    }
