...
public final class C31128C7i extends PGZ {
    public static C31128C7i A01;
    public BreakIterator A00;

    private final boolean A00(int i) {
        if (i < 0 || i >= PGZ.A01(this)) {
            return false;
        }
    ...
    public final int[] Avj(int i) {
        if (PGZ.A01(this) > 0 && i < PGZ.A01(this)) {
            if (i < 0) {
                i = 0;
            }
            ...
            if (breakIterator2 != null) {
                ...
                if (following != -1 && following > 0 && A00(following - 1) && (following == PGZ.A01(this) || !A00(following))) {
    ...
    public final int[] FVh(int i) {
        ...
        if (A012 > 0 && i > 0) {
            ...
            while (i > 0) {
                int i2 = i - 1;
                if (A00(i2) || (A00(i2) && (i == PGZ.A01(this) || !A00(i)))) {
                    break;
                }
                BreakIterator breakIterator = this.A00;
                if (breakIterator == null) {
