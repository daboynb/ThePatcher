...
public class C28975BMl extends ReplacementSpan {
    public int A00;
    public int A01;
    public Rect A02;
    ...
    public C28975BMl(Rect rect, Drawable drawable, int i) {
        this.A06 = drawable;
        this.A03 = i;
        this.A05 = rect;
        A02();
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (this instanceof CB6) {
            ...
            Paint.FontMetricsInt fontMetricsInt2 = this.A04;
            A01 = A01(fontMetricsInt2.ascent, fontMetricsInt2.descent);
        }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (fontMetricsInt != null) {
            if (this instanceof CB6) {
                ...
                int A01 = cb6.A01(i3, i4);
                int i6 = ((C28975BMl) cb6).A00 + A01;
                int i7 = cb6.A00;
                Rect rect = cb6.A05;
                int i8 = A01 - rect.top;
                if (i7 == 2) {
