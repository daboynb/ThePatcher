...
import p000X.B3D;
import p000X.C00A;
import p000X.InterfaceC70195Rco;
import p000X.KYS;
...
public class TrustlyView extends LinearLayout {
    ...
    public String A02;
    public Map A03;
    public InterfaceC70195Rco A04;
    public InterfaceC70195Rco A05;
    ...
    public TrustlyView(Context context, AttributeSet attributeSet, int i, String str) {
        ...
        webView.addJavascriptInterface(kys, "TrustlyNativeSDK");
        webView.setWebChromeClient(new B35(this, this));
        webView.setWebViewClient(new B3D(3, this, this));
        addView(webView);
    }
