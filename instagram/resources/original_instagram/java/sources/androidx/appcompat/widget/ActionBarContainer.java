...
import p000X.AbstractC71388Rxc;
...
public class ActionBarContainer extends FrameLayout {
    ...
    */
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        setBackground(f4h);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0BS.A00);
    ...
    public final void drawableStateChanged() {
        ...
        if (drawable != null && drawable.isStateful()) {
            BWI.A11(this.A00, this);
        }
        Drawable drawable2 = this.A02;
        if (drawable2 != null && drawable2.isStateful()) {
            BWI.A11(this.A02, this);
        }
        Drawable drawable3 = this.A01;
        if (drawable3 == null || !drawable3.isStateful()) {
            return;
        }
        BWI.A11(this.A01, this);
    }
    ...
    public final void onFinishInflate() {
        int A06 = AbstractC315719l.A06(-1241433528);
        super.onFinishInflate();
        this.A07 = findViewById(2131427502);
        this.A08 = findViewById(2131427603);
        AbstractC315719l.A0D(-38538374, A06);
    }
        ...
        if (this.A07 != null) {
            ...
            if (view3 == null || view3.getVisibility() == 8 || view3.getMeasuredHeight() == 0) {
                ...
                if (view4 == null || view4.getVisibility() == 8 || view4.getMeasuredHeight() == 0) {
                    ...
                    View view5 = this.A03;
                    setMeasuredDimension(measuredWidth, Math.min(i3 + BWI.A0E(BWI.A0I(view5), view5.getMeasuredHeight()), size));
                }
                view = this.A08;
            } else {
                view = this.A07;
            }
            i3 = BWI.A0E(BWI.A0I(view), view.getMeasuredHeight());
            if (mode != Integer.MIN_VALUE) {
            }
            int measuredWidth2 = getMeasuredWidth();
            View view52 = this.A03;
            setMeasuredDimension(measuredWidth2, Math.min(i3 + BWI.A0E(BWI.A0I(view52), view52.getMeasuredHeight()), size));
        }
    }

    @Override // android.view.View
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        int A05 = AbstractC315719l.A05(875077784);
        super.onTouchEvent(motionEvent);
        AbstractC315719l.A0C(1595383232, A05);
        return true;
    }
    ...
    */
    ...
    public void setTabContainer(AbstractC71388Rxc abstractC71388Rxc) {
        View view = this.A03;
        if (view != null) {
            removeView(view);
        }
        this.A03 = abstractC71388Rxc;
        if (abstractC71388Rxc != null) {
            addView(abstractC71388Rxc);
            throw AnonymousClass210.A0p("getLayoutParams");
        }
    }
    ...
    public void setVisibility(int i) {
        ...
        Drawable drawable = this.A00;
        if (drawable != null) {
            drawable.setVisible(A12, false);
        }
        Drawable drawable2 = this.A02;
        if (drawable2 != null) {
            drawable2.setVisible(A12, false);
        }
        Drawable drawable3 = this.A01;
        if (drawable3 != null) {
            drawable3.setVisible(A12, false);
        }
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable == this.A00 && !this.A04) {
            return true;
        }
        if (drawable == this.A02 && this.A05) {
            return true;
        }
        return (drawable == this.A01 && this.A04) || super.verifyDrawable(drawable);
    }
