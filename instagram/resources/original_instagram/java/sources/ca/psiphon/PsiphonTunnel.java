...
import p000X.AbstractC244669dm;
...
public class PsiphonTunnel {
    ...
    public interface HostService extends HostLogger, HostLibraryLoader {
        ...
        public abstract /* synthetic */ class CC {
            ...
            public static void $default$onInproxyProxyActivity(HostService hostService, int i, int i2, long j, long j2) {
            }
        ...
        void onInproxyProxyActivity(int i, int i2, long j, long j2);
                ...
                this.networkCallback = new ConnectivityManager.NetworkCallback() { // from class: ca.psiphon.PsiphonTunnel.NetworkMonitor.1
                    ...
                    private void setCurrentActiveNetworkAndProperties(Network network) {
                        ...
                        if (network == null) {
                            ...
                            String obj2 = AbstractC27914AsI.A0I(str, AbstractC27914AsI.A0I("NetworkMonitor: set current active network ", new StringBuilder())).toString();
                            if (!arrayList.isEmpty()) {
                                obj2 = AbstractC27914AsI.A0I(" with DNS", AbstractC27914AsI.A0I(obj2, new StringBuilder())).toString();
                            }
    ...
    public class PsiphonTunnelFeedback {
        ...
        public class RunnableC00611 implements Runnable {
            ...
            public RunnableC00611(Context context, String str, String str2, String str3, HostLogger hostLogger, String str4, String str5, HostFeedbackHandler hostFeedbackHandler) {
            ...
            public void run() {
                try {
                    Psi.startSendFeedback(PsiphonTunnel.buildPsiphonConfig(this.val$context, this.val$feedbackConfigJson, this.val$clientPlatformPrefix, this.val$clientPlatformSuffix, 0), this.val$diagnosticsJson, this.val$uploadPath, new PsiphonProviderFeedbackHandler() { // from class: ca.psiphon.PsiphonTunnel.PsiphonTunnelFeedback.1.2
                        ...
                        public void sendFeedbackCompleted(final java.lang.Exception exc) {
                            try {
                                PsiphonTunnelFeedback.this.callbackQueue.execute(new Runnable() { // from class: ca.psiphon.PsiphonTunnel.PsiphonTunnelFeedback.1.2.1
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        RunnableC00611.this.val$feedbackHandler.sendFeedbackCompleted(exc);
                                    }
                                });
                        ...
                        public String getNetworkID() {
                            return PsiphonTunnel.getNetworkID(RunnableC00611.this.val$context, false);
                        }

                        @Override // psi.PsiphonProviderNetwork
                        public long hasIPv6Route() {
                            return PsiphonTunnel.hasIPv6Route(RunnableC00611.this.val$context, RunnableC00611.this.val$logger);
                        }

                        @Override // psi.PsiphonProviderNetwork
                        public long hasNetworkConnectivity() {
                            return PsiphonTunnel.hasNetworkConnectivity(RunnableC00611.this.val$context) ? 1L : 0L;
                        }
                        ...
                        public void notice(String str) {
                            try {
                                try {
                                    ...
                                    StringBuilder A0I = AbstractC27914AsI.A0I(": ", AbstractC27914AsI.A0I(string, new StringBuilder()));
                                    A0I.append(jSONObject2);
                                    ...
                                    PsiphonTunnelFeedback.this.callbackQueue.execute(new Runnable() { // from class: ca.psiphon.PsiphonTunnel.PsiphonTunnelFeedback.1.1.1
                                        @Override // java.lang.Runnable
                                        public void run() {
                                            RunnableC00611.this.val$logger.onDiagnosticMessage(obj);
                                        }
                                    });
                                    ...
                                    PsiphonTunnelFeedback.this.callbackQueue.execute(new Runnable() { // from class: ca.psiphon.PsiphonTunnel.PsiphonTunnelFeedback.1.1.2
                                        @Override // java.lang.Runnable
                                        public void run() {
                                            HostLogger hostLogger = RunnableC00611.this.val$logger;
                                            StringBuilder A0I2 = AbstractC27914AsI.A0I("Error handling notice ", new StringBuilder());
                                            A0I2.append(e);
                                            hostLogger.onDiagnosticMessage(A0I2.toString());
                                        }
                                    });
                                }
                            } catch (RejectedExecutionException unused) {
                    ...
                    try {
                        PsiphonTunnelFeedback.this.callbackQueue.execute(new Runnable() { // from class: ca.psiphon.PsiphonTunnel.PsiphonTunnelFeedback.1.4
                            @Override // java.lang.Runnable
                            public void run() {
                                RunnableC00611.this.val$feedbackHandler.sendFeedbackCompleted(new Exception("Error sending feedback", e));
                            }
                        });
                    } catch (RejectedExecutionException unused) {
                    }
        ...
        public void startSendFeedback(Context context, HostFeedbackHandler hostFeedbackHandler, HostLogger hostLogger, String str, String str2, String str3, String str4, String str5) {
            this.workQueue.execute(new RunnableC00611(context, str, str4, str5, hostLogger, str2, str3, hostFeedbackHandler));
        }
    }
    ...
    public static String buildPsiphonConfig(Context context, String str, String str2, String str3, Integer num) {
        ...
        if (!jSONObject.has("DataRootDirectory")) {
            ...
            if (!defaultDataRootDirectory.exists() && !defaultDataRootDirectory.mkdir()) {
                throw new Exception(AbstractC27914AsI.A0I(defaultDataRootDirectory.getPath(), AbstractC27914AsI.A0I("failed to create data root directory: ", new StringBuilder())).toString());
            }
    ...
    public String getDNSServers(Context context, HostLogger hostLogger) {
        ...
        try {
            ...
            hostLogger.onDiagnosticMessage(AbstractC27914AsI.A0I(e.getMessage(), AbstractC27914AsI.A0I("failed to get active network DNS resolver: ", new StringBuilder())).toString());
            return str;
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r3v1, types: [android.net.ConnectivityManager] */
    /* JADX WARN: Type inference failed for: r3v3, types: [java.lang.String] */
    /* JADX WARN: Type inference failed for: r3v4, types: [java.lang.String] */
    public static String getNetworkID(Context context, boolean z) {
        NetworkCapabilities networkCapabilities;
        String str = (ConnectivityManager) context.getSystemService("connectivity");
        NetworkInfo networkInfo = null;
        if (Build.VERSION.SDK_INT >= 23 && !z) {
            try {
                networkCapabilities = str.getNetworkCapabilities(str.getActiveNetwork());
            } catch (java.lang.Exception unused) {
        ...
        try {
            networkInfo = str.getActiveNetworkInfo();
        } catch (java.lang.Exception unused2) {
        }
        try {
            if (networkInfo != null && networkInfo.getType() == 1) {
                str = "WIFI";
                WifiInfo A00 = AbstractC244669dm.A00((WifiManager) context.getApplicationContext().getSystemService("wifi"));
                if (A00 != null) {
                    ...
                    return AbstractC27914AsI.A0I(bssid, AbstractC27914AsI.A0I("-", AbstractC27914AsI.A0I("WIFI", new StringBuilder()))).toString();
                }
            } else {
                ...
                TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
                if (telephonyManager != null) {
                    return AbstractC27914AsI.A0I(telephonyManager.getNetworkOperator(), AbstractC27914AsI.A0I("-", AbstractC27914AsI.A0I("MOBILE", new StringBuilder()))).toString();
                }
            }
    ...
    private void handlePsiphonNotice(String str) {
        try {
            ...
            if (string.equals("Tunnels")) {
                switch (jSONObject.getJSONObject("data").getInt("count")) {
                    case 0:
                ...
                if (string.equals("AvailableEgressRegions")) {
                    ...
                    int i2 = jSONObject.getJSONObject("data").getInt("port");
                    setLocalSocksProxyPort(i2);
                    this.mHostService.onListeningSocksProxyPort(i2);
            ...
            StringBuilder A0I = AbstractC27914AsI.A0I(": ", AbstractC27914AsI.A0I(string, new StringBuilder()));
            A0I.append(jSONObject.getJSONObject("data"));
            this.mHostService.onDiagnosticMessage(A0I.toString());
            ...
            while (it.hasNext()) {
                ...
                if (networkInterface.isUp() && !networkInterface.isLoopback()) {
                    ...
                    if (inetAddresses == null) {
                        throw new IllegalStateException(AbstractC27914AsI.A0I(networkInterface.getName(), AbstractC27914AsI.A0I("no addresses found for network interface ", new StringBuilder())).toString());
                    }
    ...
    public class Exception extends java.lang.Exception {
        ...
        public Exception(String str, Throwable th) {
            super(AbstractC27914AsI.A0I(th.getMessage(), AbstractC27914AsI.A0I(": ", AbstractC27914AsI.A0I(str, new StringBuilder()))).toString());
        }
    }
    ...
    public static long hasIPv6Route(Context context, HostLogger hostLogger) {
        ...
        try {
            ...
            if (hostLogger != null) {
                hostLogger.onDiagnosticMessage(AbstractC27914AsI.A0I(e.getMessage(), AbstractC27914AsI.A0I("failed to check IPv6 route: ", new StringBuilder())).toString());
            }
            z = false;
        }
        if (z) {
