...
public class LocationContext extends AutoSafeParcelable {
    ...
    public static final Parcelable.Creator CREATOR = new C187347Ko(LocationContext.class);
    ...
    public String mContextState = "ContextStateUnknown";

    @SafeParcelable.Field(3)
    public String mActivityState = "ActivityStateUnknown";
