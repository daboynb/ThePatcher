...
public final class TraceConfigExtras implements Parcelable {
    ...
    public static final Parcelable.Creator CREATOR = new C247269hy(6);
    public final int A00;
    public final InterfaceC98686ovn A01;
    ...
    public final int A00(String str, int i) {
        Number number;
        InterfaceC98686ovn interfaceC98686ovn = this.A01;
        if (interfaceC98686ovn != null) {
            return interfaceC98686ovn.optTraceConfigParamInt(this.A00, str, i);
        }
    ...
    public final String A01(String str, String str2) {
        ...
        InterfaceC98686ovn interfaceC98686ovn = this.A01;
        if (interfaceC98686ovn != null) {
            return interfaceC98686ovn.optTraceConfigParamString(this.A00, str, str2);
        }
        TreeMap treeMap = this.A06;
        return (treeMap == null || (str3 = (String) treeMap.get(str)) == null) ? str2 : str3;
    }
    ...
    public final boolean A02(String str, boolean z) {
        ...
        InterfaceC98686ovn interfaceC98686ovn = this.A01;
        if (interfaceC98686ovn != null) {
            return interfaceC98686ovn.optTraceConfigParamBool(this.A00, str, z);
        }
    ...
    public final int[] A03(String str) {
        InterfaceC98686ovn interfaceC98686ovn = this.A01;
        if (interfaceC98686ovn != null) {
            return interfaceC98686ovn.optTraceConfigParamIntList(this.A00, str);
        }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        int i2 = this.A00;
        if (i2 >= 0 && (interfaceC98686ovn = this.A01) != null) {
            ConfigParams traceConfigParams = interfaceC98686ovn.getTraceConfigParams(i2);
    ...
    public TraceConfigExtras(InterfaceC98686ovn interfaceC98686ovn, int i) {
        this.A01 = interfaceC98686ovn;
        this.A00 = i;
        this.A04 = null;
        this.A03 = null;
        this.A02 = null;
    ...
    public TraceConfigExtras(Parcel parcel) {
        ...
        AbstractC10490Qj.A00(readBundle);
        ...
        AbstractC10490Qj.A00(readBundle2);
        ...
        AbstractC10490Qj.A00(readBundle3);
