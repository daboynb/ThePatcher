...
public class Achilles implements Runnable {
    ...
    public static void attack(Object obj, long j) {
        ...
        thread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: X.1jk
            @Override // java.lang.Thread.UncaughtExceptionHandler
            public final void uncaughtException(Thread thread2, Throwable th) {
                C44641jw.A01("Achilles", "Uncaught exception in Achilles thread", th);
            }
        });
        thread.start();
        try {
        ...
        if (achilles.exc != null) {
            if (BuildConstants.A02()) {
                C44641jw.A03(achilles.exc);
            } else {
                C44641jw.A01("Achilles", "Caught exception in Achilles thread", achilles.exc);
            }
        }
    }
    ...
    public static void simulateReportClassLoaderChainQ(String[] strArr, BaseDexClassLoader baseDexClassLoader, List list, List list2, String str, String str2, PackageManager packageManager, boolean z) {
        attack(new Arrow(strArr, baseDexClassLoader, list, list2, "com.instagram.android", str2, packageManager, z), srclc());
    }
    ...
    public static void simulateReportClassLoaderChainR(BaseDexClassLoader baseDexClassLoader, String str, String str2, PackageManager packageManager, boolean z) {
        attack(new Arrow(baseDexClassLoader, "com.instagram.android", str2, packageManager, z), srclc());
    }
