...
public class DalvikInternals {
    ...
    static {
        C22Q.loadLibrary("dextricks");
        ignoreSIGPIPE();
        boolean z = AbstractC10560Qq.A00;
        setIsArt(z);
        int i = Build.VERSION.SDK_INT;
        setSdkInt(i);
        StringBuilder sb = new StringBuilder();
        AbstractC27914AsI.A0I("IsArt = ", sb);
        sb.append(z);
        ...
        if (z) {
            ...
            try {
                nopDvmVerifyClass();
                AbstractC44671jz.A00("Hooked nop dvmVerifyClass", new Object[0]);
            } catch (RuntimeException e) {
                Mlog.m101w("Failed to nop dvmVerifyClass", e);
            }
        }
        INITED = true;
