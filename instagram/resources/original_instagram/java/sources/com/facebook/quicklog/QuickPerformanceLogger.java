...
public interface QuickPerformanceLogger extends LightweightQuickPerformanceLogger {
    ...
    void markerPoint(int i, int i2, int i3, String str, C101813tx c101813tx, long j, TimeUnit timeUnit, int i4);
    ...
    void markerStartForLegacy(int i, int i2, long j, TimeUnit timeUnit, InterfaceC38581aA interfaceC38581aA);

    void markerStartForLegacy(int i, long j, TimeUnit timeUnit, InterfaceC38581aA interfaceC38581aA);
