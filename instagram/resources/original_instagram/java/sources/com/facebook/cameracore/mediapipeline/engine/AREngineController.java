...
import p000X.C22Q;
import p000X.C41N;
import p000X.C88020aVS;
import p000X.D1F;

/* loaded from: classes6.dex */
public final class AREngineController {
    public static final C88020aVS Companion = new C88020aVS();
    ...
    public AREngineController(AssetManager assetManager, AndroidAsyncExecutorFactory androidAsyncExecutorFactory, AndroidAsyncExecutorFactory androidAsyncExecutorFactory2, PluginConfigProvider pluginConfigProvider) {
        AnonymousClass011.A0q(assetManager, androidAsyncExecutorFactory, androidAsyncExecutorFactory2);
        synchronized (Companion) {
            if (!isLibraryLoaded) {
                isLibraryStartLoading = true;
                C22Q.loadLibrary("filters-native-android");
    ...
    public final boolean renderSessionInit(boolean z, C41N c41n, int i, GPUTimerImpl gPUTimerImpl, HybridLogSink hybridLogSink, boolean z2) {
        D1F.A0z(c41n);
        return renderSessionInit(z, c41n.A00, i, gPUTimerImpl != null ? gPUTimerImpl : null, (HybridLogSink) null, z2);
    }
