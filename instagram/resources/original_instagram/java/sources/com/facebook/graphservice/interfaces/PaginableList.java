...
import p000X.AbstractC39647FcB;
import p000X.HG0;

/* loaded from: classes8.dex */
public class PaginableList extends HG0 {
    ...
    */
    ...
    public GraphQLService.Token loadNextPageWithService(GraphQLService graphQLService, AbstractC39647FcB abstractC39647FcB, Executor executor) {
        return loadNextPageWithService(graphQLService, abstractC39647FcB, executor, "");
    }

    public GraphQLService.Token loadPreviousPageWithService(GraphQLService graphQLService, AbstractC39647FcB abstractC39647FcB, Executor executor) {
        return loadPreviousPageWithService(graphQLService, abstractC39647FcB, executor, "");
    }
    ...
    public GraphQLService.Token loadNextPageWithService(GraphQLService graphQLService, AbstractC39647FcB abstractC39647FcB, Executor executor, String str) {
        if (this.paginationKey.equals("MISSING_PAGINATION_KEY")) {
            return null;
        }
        throw new NullPointerException("getTotalPageSize");
    }

    public GraphQLService.Token loadPreviousPageWithService(GraphQLService graphQLService, AbstractC39647FcB abstractC39647FcB, Executor executor, String str) {
        if (this.paginationKey.equals("MISSING_PAGINATION_KEY")) {
            return null;
        }
        throw new NullPointerException("getTotalPageSize");
