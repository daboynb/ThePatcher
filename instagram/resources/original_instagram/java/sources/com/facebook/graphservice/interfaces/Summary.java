...
public class Summary implements InterfaceC78736Vm6 {
    ...
    public final boolean elasticEnabled;
    public final boolean elasticExecutionTimedOut;
    ...
    public final long requestFirstByteFlushed;
    public final long requestLastByteAcked;
    ...
    public Summary(String str, boolean z, boolean z2, String str2, int i, List list, long j, long j2, long j3, long j4, long j5, long j6, long j7, int i2, long j8, long j9, long j10, long j11, long j12, long j13, boolean z3, int i3, int i4, String str3, String str4, String str5, boolean z4, boolean z5, boolean z6, String str6, long j14, long j15, long j16, long j17, boolean z7, String str7, long j18, long j19, boolean z8, boolean z9, GraphQLQuery graphQLQuery) {
        ...
        this.requestStart = j;
        this.requestFirstByteFlushed = j2;
        this.requestLastByteAcked = j3;
        this.networkStart = j4;
        this.networkEnd = j5;
        this.parseStart = j6;
        this.requestEnd = j7;
        this.parsedDataSize = i2;
        this.additiveParseTimeMs = j8;
        this.networkChunksCount = j9;
        this.additiveThreadHopTimeMs = j10;
        this.fetchCachedResponseStart = j11;
        this.fetchCachedResponseEnd = j12;
        this.cachedResponseAge = j13;
        ...
        this.serverFlushTime = j15;
        this.cacheSyncStart = j16;
        this.cacheSyncEnd = j17;
        this.rejectedFromAdaptiveFetch = z7;
        this.prefetchPredictionID = str7;
        this.rtt = j18;
        this.upstreamLatency = j19;
        this.elasticEnabled = z8;
        this.elasticExecutionTimedOut = z9;
    ...
    public String toString() {
        ...
        A00.A03("requestFirstByteFlushed", this.requestFirstByteFlushed);
        A00.A03("requestLastByteAcked", this.requestLastByteAcked);
        ...
        A00.A03("rtt", this.rtt);
        A00.A03("upstreamLatency", this.upstreamLatency);
        A00.A04("elasticEnabled", this.elasticEnabled);
        A00.A04("elasticExecutionTimedOut", this.elasticExecutionTimedOut);
        return A00.toString();
    }
