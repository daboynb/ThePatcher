...
public final class CoordinationMessage extends C36U implements InterfaceC63321OoW {
    ...
    public AbstractC238249Ki payload_ = AbstractC238249Ki.A02;
    public int type_;

    static {
        CoordinationMessage coordinationMessage = new CoordinationMessage();
        DEFAULT_INSTANCE = coordinationMessage;
        C36U.A06(coordinationMessage, CoordinationMessage.class);
    }

    public static CoordinationMessage parseFrom(ByteBuffer byteBuffer) {
        return (CoordinationMessage) C36U.A02(DEFAULT_INSTANCE, byteBuffer);
    }
