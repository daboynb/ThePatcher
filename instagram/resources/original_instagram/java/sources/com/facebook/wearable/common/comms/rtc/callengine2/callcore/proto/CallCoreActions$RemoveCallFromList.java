...
public final class CallCoreActions$RemoveCallFromList extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(callCoreActions$RemoveCallFromList, CallCoreActions$RemoveCallFromList.class);
    }

    public static CallCoreActions$RemoveCallFromList parseFrom(ByteBuffer byteBuffer) {
        return (CallCoreActions$RemoveCallFromList) C36U.A02(DEFAULT_INSTANCE, byteBuffer);
    }
