...
import p000X.C22Q;
import p000X.C49592JWo;

/* loaded from: classes9.dex */
public final class TurntableCameraControl {
    public static final C49592JWo Companion = new C49592JWo();
    ...
    public final native void setRadius(float f);
