...
public final class Duration extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(duration, Duration.class);
    }

    public static Duration parseFrom(ByteBuffer data) {
        return (Duration) C36U.A02(DEFAULT_INSTANCE, data);
    }
