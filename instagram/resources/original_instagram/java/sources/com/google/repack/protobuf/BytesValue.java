...
public final class BytesValue extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(bytesValue, BytesValue.class);
    }

    public static BytesValue parseFrom(ByteBuffer data) {
        return (BytesValue) C36U.A02(DEFAULT_INSTANCE, data);
    }
