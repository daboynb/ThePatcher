...
public final class BoolValue extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(boolValue, BoolValue.class);
    }

    public static BoolValue parseFrom(ByteBuffer data) {
        return (BoolValue) C36U.A02(DEFAULT_INSTANCE, data);
    }
