...
public final class Int64Value extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(int64Value, Int64Value.class);
    }

    public static Int64Value parseFrom(ByteBuffer data) {
        return (Int64Value) C36U.A02(DEFAULT_INSTANCE, data);
    }
