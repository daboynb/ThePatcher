...
public final class DoubleValue extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(doubleValue, DoubleValue.class);
    }

    public static DoubleValue parseFrom(ByteBuffer data) {
        return (DoubleValue) C36U.A02(DEFAULT_INSTANCE, data);
    }
