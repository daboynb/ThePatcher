...
public final class Int32Value extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(int32Value, Int32Value.class);
    }

    public static Int32Value parseFrom(ByteBuffer data) {
        return (Int32Value) C36U.A02(DEFAULT_INSTANCE, data);
    }
