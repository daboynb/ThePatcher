...
public final class UInt64Value extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(uInt64Value, UInt64Value.class);
    }

    public static UInt64Value parseFrom(ByteBuffer data) {
        return (UInt64Value) C36U.A02(DEFAULT_INSTANCE, data);
    }
