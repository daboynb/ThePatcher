...
public abstract class zza implements IInterface {
    ...
    public zza(IBinder iBinder) {
        int A03 = AbstractC315719l.A03(1141805010);
        this.A01 = iBinder;
        this.A00 = "com.google.android.gms.fido.fido2.internal.regular.IFido2AppService";
        AbstractC315719l.A0A(332168626, A03);
    }

    public final void A00(Parcel parcel, int i) {
        int A03 = AbstractC315719l.A03(-691077886);
        Parcel obtain = Parcel.obtain();
        try {
            AnonymousClass120.A0L(this.A01, parcel, obtain, i);
            parcel.recycle();
            obtain.recycle();
            AbstractC315719l.A0A(-526081574, A03);
        } catch (Throwable th) {
            parcel.recycle();
            obtain.recycle();
            AbstractC315719l.A0A(1844929344, A03);
            throw th;
        }
    }
    ...
    public final IBinder asBinder() {
        int A03 = AbstractC315719l.A03(9426838);
        IBinder iBinder = this.A01;
        AbstractC315719l.A0A(-950449876, A03);
        return iBinder;
    }
}
