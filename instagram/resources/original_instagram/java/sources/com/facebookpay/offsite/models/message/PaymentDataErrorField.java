...
public final class PaymentDataErrorField {
    ...
    public static final PaymentDataErrorField city = new PaymentDataErrorField("city", 0);
    ...
    public static final PaymentDataErrorField region = new PaymentDataErrorField("region", 6);
