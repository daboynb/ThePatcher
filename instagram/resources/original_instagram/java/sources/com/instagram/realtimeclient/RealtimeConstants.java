...
public final class RealtimeConstants {
    ...
    public static final RealtimeConstants INSTANCE = new RealtimeConstants();
    ...
    public static final String MQTT_TOPIC_DISABLE_PRESENCE_REPORTING = "/disable_presence_reporting";
