...
public final class RealtimeProtocol {
    ...
    public static final String DIRECT_PALS_FEATURE_STATUS = "/direct_v2/threads/:direct_v2_thread_id/pals_feature_status";
    ...
    public static final String DIRECT_V2_AI_BOT_GROUP_ACTIVITIES_CURRENT_STATE = "/direct_v2/threads/:direct_v2_thread_id/ai_bot_group_activities_current_state";
    ...
    public static final String DIRECT_V2_INBOX_LAST_MENTIONED_DIGEST_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/last_mentioned_item";
    ...
    public static final String DIRECT_V2_INBOX_REELS_BLEND_PAYLOAD_UPDATE = "/direct_v2/threads/:direct_v2_thread_id/blend_payload";
    public static final String DIRECT_V2_INBOX_THREAD_IS_STALE_TEMPLATE = "/direct_v2/inbox/threads/:direct_v2_thread_id/is_stale";
    ...
    public static final String DIRECT_V2_ONE_CLICK_UPSELL_UPDATE = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/update_one_click_upsell";
    ...
    public static final String DIRECT_V2_THREAD_MEDIA_LIKE_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/media/like/:direct_v2_user_id";
    ...
    public static final String f34x52704834 = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/batched_reactions_viewer_reaction";
    ...
    public static final String DIRECT_V2_THREAD_MESSAGE_KAI_METADATA_UPDATE_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/update_kai_metadata";
    ...
    public static final String f35x9385be2b = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/policy_violation/visibility";
    ...
    public static final String DIRECT_V2_THREAD_NEW_FRIEND_BUMP_TEMPLATE = "/direct_v2/inbox/threads/:direct_v2_thread_id/is_new_friend_bump";
    ...
    public static final String DIRECT_V2_THREAD_REFETCH_MESSAGE_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/refetch_message";
    ...
    public static final String f36xeaf2317 = "/users/:direct_v2_user_id/friendship_status/is_messaging_only_blocking";

    /* renamed from: REPLACE_USERS_FRIENDSHIP_STATUS_MESSAGING_PSEUDO_BLOCKING_TEMPLATE */
    public static final String f37xc82f5fc8 = "/users/:direct_v2_user_id/friendship_status/is_messaging_pseudo_blocking";
