...
public class GetCurrentAccountStateOperationSuccess extends OperationResult {
    ...
    public final class Companion {
        public final FAM serializer() {
            return C40964FxQ.A00;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ GetCurrentAccountStateOperationSuccess(int i, ResponseCode responseCode, AbstractC61635O5t abstractC61635O5t) {
        super(i, responseCode, abstractC61635O5t);
        if (1 != (i & 1)) {
            AbstractC66454Py2.A00(C40964FxQ.A01, i, 1);
