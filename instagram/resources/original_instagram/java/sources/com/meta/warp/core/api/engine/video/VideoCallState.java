...
public final class VideoCallState extends C36U implements InterfaceC63321OoW {
    ...
    public InterfaceC65019Pas participantStates_ = C9KM.A02;

    static {
        VideoCallState videoCallState = new VideoCallState();
        DEFAULT_INSTANCE = videoCallState;
        C36U.A06(videoCallState, VideoCallState.class);
    }

    public static VideoCallState parseFrom(ByteBuffer byteBuffer) {
        return (VideoCallState) C36U.A02(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    public final Object dynamicMethod(C9KZ c9kz, Object obj, Object obj2) {
        ...
        switch (c9kz) {
            ...
            case BUILD_MESSAGE_INFO:
                return C36U.A04(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0001\u0000\u0001Ȉ\u0002\u001b\u0003\u0007", new Object[]{"callId_", "participantStates_", VideoCallParticipantState.class, "mitigated_"});
            case NEW_MUTABLE_INSTANCE:
                return new VideoCallState();
            case NEW_BUILDER:
                return new C40230Fla();
