...
public final class CameraActions$UpdateActiveCameraHardware extends C36U implements InterfaceC63321OoW {
    ...
    static {
        ...
        C36U.A06(cameraActions$UpdateActiveCameraHardware, CameraActions$UpdateActiveCameraHardware.class);
    }

    public static CameraActions$UpdateActiveCameraHardware parseFrom(ByteBuffer byteBuffer) {
        return (CameraActions$UpdateActiveCameraHardware) C36U.A02(DEFAULT_INSTANCE, byteBuffer);
    }
