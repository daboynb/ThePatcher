...
public class PackageManagerHook implements Hook {
    ...
    // Track SigningInfo objects belonging to Telegram so the method hooks know which to intercept
    private static final Set<SigningInfo> telegramSigningInfos =
    ...
    private static void replaceSigningInfo(PackageInfo package_info) {
        ...
        telegramSigningInfos.add(package_info.signingInfo);
    ...
    static Signature[] getApkContentsSigners_hook(SigningInfo obj) {
        if (telegramSigningInfos.contains(obj)) {
    ...
    static PackageInfo get_package_info_hook(PackageManager obj, String package_name, PackageManager.PackageInfoFlags flags) {
        ...
        if (package_name.startsWith("org.telegram.messenger") && ((flags.getValue() & 64) != 0 || (flags.getValue() & 0x8000000) != 0) && package_info != null) {
    ...
    static PackageInfo get_package_info_hook(PackageManager obj, String package_name, int flags) {
        ...
        if (package_name.startsWith("org.telegram.messenger") && ((flags & 64) != 0 || (flags & 0x8000000) != 0) && package_info != null) {
            Log.i("PATCH", "PackageManagerHook: Replacing package info...");
            replaceSigningInfo(package_info);
        }
        return package_info;
